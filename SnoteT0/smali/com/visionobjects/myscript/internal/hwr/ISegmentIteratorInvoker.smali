.class public final Lcom/visionobjects/myscript/internal/hwr/ISegmentIteratorInvoker;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/visionobjects/myscript/internal/hwr/ISegmentIteratorInvoker$GetParameters;,
        Lcom/visionobjects/myscript/internal/hwr/ISegmentIteratorInvoker$GetInputRangeParameters;
    }
.end annotation
...
.field private static final GET_CANDIDATES:I = 0x5

.field private static final GET_INPUT_RANGE:I = 0x2

.field private static final GET_RESEMBLANCE_SCORE:I = 0x4

.field private static final GET_SELECTED_CANDIDATE_INDEX:I = 0x3

.field private static final IFACE:I

.field static class$com$visionobjects$myscript$internal$hwr$ISegmentIteratorInvoker:Ljava/lang/Class;
...
.method static constructor <clinit>()V
    ...
    sget-object v0, Lcom/visionobjects/myscript/internal/hwr/ISegmentIteratorInvoker;->class$com$visionobjects$myscript$internal$hwr$ISegmentIteratorInvoker:Ljava/lang/Class;

    if-nez v0, :cond_0

    const-string v0, "com.visionobjects.myscript.internal.hwr.ISegmentIteratorInvoker"

    invoke-static {v0}, Lcom/visionobjects/myscript/internal/hwr/ISegmentIteratorInvoker;->class$(Ljava/lang/String;)Ljava/lang/Class;

    move-result-object v0

    sput-object v0, Lcom/visionobjects/myscript/internal/hwr/ISegmentIteratorInvoker;->class$com$visionobjects$myscript$internal$hwr$ISegmentIteratorInvoker:Ljava/lang/Class;
    ...
    :goto_1
    sput-boolean v0, Lcom/visionobjects/myscript/internal/hwr/ISegmentIteratorInvoker;->$assertionsDisabled:Z

    sget-object v0, Lcom/visionobjects/myscript/internal/hwr/VO_HWR_I;->VO_ISegmentIterator:Lcom/visionobjects/myscript/internal/hwr/VO_HWR_I;

    invoke-virtual {v0}, Lcom/visionobjects/myscript/internal/hwr/VO_HWR_I;->getValue()I

    move-result v0

    sput v0, Lcom/visionobjects/myscript/internal/hwr/ISegmentIteratorInvoker;->IFACE:I
...
.method public final getCandidates(Lcom/visionobjects/myscript/engine/EngineObject;)Lcom/visionobjects/myscript/hwr/CandidateIterator;
    ...
    sget v2, Lcom/visionobjects/myscript/internal/hwr/ISegmentIteratorInvoker;->IFACE:I

    invoke-static {v0, v1, v7, v8, v2}, Lcom/visionobjects/myscript/internal/engine/Library;->getInterface(JJI)J

    move-result-wide v2

    new-instance v5, Lcom/visionobjects/myscript/internal/hwr/ISegmentIteratorInvoker$GetParameters;

    invoke-direct {v5}, Lcom/visionobjects/myscript/internal/hwr/ISegmentIteratorInvoker$GetParameters;-><init>()V

    iget-object v4, v5, Lcom/visionobjects/myscript/internal/hwr/ISegmentIteratorInvoker$GetParameters;->engine:Lcom/visionobjects/myscript/internal/engine/ParameterList$OpaquePointer;

    invoke-virtual {v4, v0, v1}, Lcom/visionobjects/myscript/internal/engine/ParameterList$OpaquePointer;->set(J)V

    iget-object v4, v5, Lcom/visionobjects/myscript/internal/hwr/ISegmentIteratorInvoker$GetParameters;->target:Lcom/visionobjects/myscript/internal/engine/ParameterList$OpaquePointer;
    ...
    :cond_1
    sget-boolean v4, Lcom/visionobjects/myscript/internal/hwr/ISegmentIteratorInvoker;->$assertionsDisabled:Z
...
.method public final getInputRange(Lcom/visionobjects/myscript/engine/EngineObject;)[Lcom/visionobjects/myscript/internal/hwr/voInputRangeElement;
    ...
    new-instance v5, Lcom/visionobjects/myscript/internal/hwr/ISegmentIteratorInvoker$GetInputRangeParameters;

    invoke-direct {v5}, Lcom/visionobjects/myscript/internal/hwr/ISegmentIteratorInvoker$GetInputRangeParameters;-><init>()V

    iget-object v8, v5, Lcom/visionobjects/myscript/internal/hwr/ISegmentIteratorInvoker$GetInputRangeParameters;->engine:Lcom/visionobjects/myscript/internal/engine/ParameterList$OpaquePointer;

    invoke-virtual {v8, v0, v1}, Lcom/visionobjects/myscript/internal/engine/ParameterList$OpaquePointer;->set(J)V

    iget-object v8, v5, Lcom/visionobjects/myscript/internal/hwr/ISegmentIteratorInvoker$GetInputRangeParameters;->target:Lcom/visionobjects/myscript/internal/engine/ParameterList$OpaquePointer;
    ...
    iget-object v7, v5, Lcom/visionobjects/myscript/internal/hwr/ISegmentIteratorInvoker$GetInputRangeParameters;->range:Lcom/visionobjects/myscript/internal/engine/ParameterList$Pointer;
