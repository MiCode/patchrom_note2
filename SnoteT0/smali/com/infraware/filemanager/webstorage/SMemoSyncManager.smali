.class public Lcom/infraware/filemanager/webstorage/SMemoSyncManager;
...
# static fields
.field private static synthetic $SWITCH_TABLE$com$infraware$filemanager$webstorage$SMemoSyncManager$E_WEBSYNC_STEP:[I

.field private static synthetic $SWITCH_TABLE$com$infraware$uxcontrol$uiunit$UiEnum$EUnitCommand:[I

.field private static INSTANCE:Lcom/infraware/filemanager/webstorage/SMemoSyncManager;
...
.field private m_eWebSyncStep:Lcom/infraware/filemanager/webstorage/SMemoSyncManager$E_WEBSYNC_STEP;
...
.field private m_oWebRootFolderIter:Ljava/util/Iterator;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/Iterator",
            "<",
...
.field private m_oWebRootFolerList:Ljava/util/ArrayList;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/ArrayList",
            "<",
...
.field private m_oWebSyncModel:Lcom/infraware/filemanager/webstorage/syncmodel/SMemoSyncModel;
...
# direct methods
.method static synthetic $SWITCH_TABLE$com$infraware$filemanager$webstorage$SMemoSyncManager$E_WEBSYNC_STEP()[I
    .locals 3

    .prologue
    .line 28
    sget-object v0, Lcom/infraware/filemanager/webstorage/SMemoSyncManager;->$SWITCH_TABLE$com$infraware$filemanager$webstorage$SMemoSyncManager$E_WEBSYNC_STEP:[I
    ...
    :cond_0
    invoke-static {}, Lcom/infraware/filemanager/webstorage/SMemoSyncManager$E_WEBSYNC_STEP;->values()[Lcom/infraware/filemanager/webstorage/SMemoSyncManager$E_WEBSYNC_STEP;
    ...
    :try_start_0
    sget-object v1, Lcom/infraware/filemanager/webstorage/SMemoSyncManager$E_WEBSYNC_STEP;->eWEBSYNC_STEP_CANCEL:Lcom/infraware/filemanager/webstorage/SMemoSyncManager$E_WEBSYNC_STEP;

    invoke-virtual {v1}, Lcom/infraware/filemanager/webstorage/SMemoSyncManager$E_WEBSYNC_STEP;->ordinal()I
    ...
    :goto_3
    :try_start_3
    sget-object v1, Lcom/infraware/filemanager/webstorage/SMemoSyncManager$E_WEBSYNC_STEP;->eWEBSYNC_STEP_FINISH:Lcom/infraware/filemanager/webstorage/SMemoSyncManager$E_WEBSYNC_STEP;
    ...
    :goto_7
    sput-object v0, Lcom/infraware/filemanager/webstorage/SMemoSyncManager;->$SWITCH_TABLE$com$infraware$filemanager$webstorage$SMemoSyncManager$E_WEBSYNC_STEP:[I
...
.method static synthetic $SWITCH_TABLE$com$infraware$uxcontrol$uiunit$UiEnum$EUnitCommand()[I
    ...
    .prologue
    .line 28
    sget-object v0, Lcom/infraware/filemanager/webstorage/SMemoSyncManager;->$SWITCH_TABLE$com$infraware$uxcontrol$uiunit$UiEnum$EUnitCommand:[I
    ...
    :goto_110
    sput-object v0, Lcom/infraware/filemanager/webstorage/SMemoSyncManager;->$SWITCH_TABLE$com$infraware$uxcontrol$uiunit$UiEnum$EUnitCommand:[I
...
.method static constructor <clinit>()V
    ...
    .prologue
    .line 41
    new-instance v0, Lcom/infraware/filemanager/webstorage/SMemoSyncManager;

    invoke-direct {v0}, Lcom/infraware/filemanager/webstorage/SMemoSyncManager;-><init>()V

    sput-object v0, Lcom/infraware/filemanager/webstorage/SMemoSyncManager;->INSTANCE:Lcom/infraware/filemanager/webstorage/SMemoSyncManager;
...
.method private constructor <init>()V
    ...
    iput-object v0, p0, Lcom/infraware/filemanager/webstorage/SMemoSyncManager;->m_oWebFileList:Ljava/util/ArrayList;
    ...
    iput-object v0, p0, Lcom/infraware/filemanager/webstorage/SMemoSyncManager;->m_oLocalFileList:Ljava/util/ArrayList;
    ...
    iput-object v0, p0, Lcom/infraware/filemanager/webstorage/SMemoSyncManager;->m_oWebRootFolerList:Ljava/util/ArrayList;

    .line 52
    iput-object v1, p0, Lcom/infraware/filemanager/webstorage/SMemoSyncManager;->m_oDownloadFileIter:Ljava/util/Iterator;

    .line 53
    iput-object v1, p0, Lcom/infraware/filemanager/webstorage/SMemoSyncManager;->m_oWebRootFolderIter:Ljava/util/Iterator;

    .line 55
    new-instance v0, Lcom/infraware/filemanager/webstorage/syncmodel/SMemoSyncModel;

    invoke-direct {v0}, Lcom/infraware/filemanager/webstorage/syncmodel/SMemoSyncModel;-><init>()V

    iput-object v0, p0, Lcom/infraware/filemanager/webstorage/SMemoSyncManager;->m_oWebSyncModel:Lcom/infraware/filemanager/webstorage/syncmodel/SMemoSyncModel;

    .line 57
    iput v2, p0, Lcom/infraware/filemanager/webstorage/SMemoSyncManager;->m_nMaxSyncCount:I

    .line 58
    iput-boolean v2, p0, Lcom/infraware/filemanager/webstorage/SMemoSyncManager;->m_bShowProgressUI:Z

    .line 62
    iput-object v1, p0, Lcom/infraware/filemanager/webstorage/SMemoSyncManager;->m_oToast:Landroid/widget/Toast;

    .line 63
    iput-object v1, p0, Lcom/infraware/filemanager/webstorage/SMemoSyncManager;->m_oCancelTimer:Ljava/util/Timer;

    .line 64
    iput-object v1, p0, Lcom/infraware/filemanager/webstorage/SMemoSyncManager;->m_oCancelTimerTask:Ljava/util/TimerTask;

    .line 66
    sget-object v0, Lcom/infraware/filemanager/webstorage/SMemoSyncManager$E_WEBSYNC_STEP;->eWEBSYNC_STEP_IDLE:Lcom/infraware/filemanager/webstorage/SMemoSyncManager$E_WEBSYNC_STEP;

    iput-object v0, p0, Lcom/infraware/filemanager/webstorage/SMemoSyncManager;->m_eWebSyncStep:Lcom/infraware/filemanager/webstorage/SMemoSyncManager$E_WEBSYNC_STEP;

    .line 68
    iput-object v1, p0, Lcom/infraware/filemanager/webstorage/SMemoSyncManager;->m_oUpdateListener:Lcom/infraware/filemanager/webstorage/WebSyncManager$IUpdateListListener;

    .line 302
    new-instance v0, Lcom/infraware/filemanager/webstorage/SMemoSyncManager$1;

    invoke-direct {v0, p0}, Lcom/infraware/filemanager/webstorage/SMemoSyncManager$1;-><init>(Lcom/infraware/filemanager/webstorage/SMemoSyncManager;)V

    iput-object v0, p0, Lcom/infraware/filemanager/webstorage/SMemoSyncManager;->m_oHandler:Landroid/os/Handler;

    .line 70
    return-void
.end method

.method static synthetic access$0(Lcom/infraware/filemanager/webstorage/SMemoSyncManager;ZI)V
    .locals 0
    .parameter
    .parameter
    .parameter
    ...
    .prologue
    .line 420
    invoke-direct {p0, p1, p2}, Lcom/infraware/filemanager/webstorage/SMemoSyncManager;->nextStep(ZI)V

    return-void
.end method

.method static synthetic access$1(Lcom/infraware/filemanager/webstorage/SMemoSyncManager;)Lcom/infraware/filemanager/webstorage/syncmodel/SMemoSyncModel;
    .locals 1
    .parameter

    .prologue
    .line 55
    iget-object v0, p0, Lcom/infraware/filemanager/webstorage/SMemoSyncManager;->m_oWebSyncModel:Lcom/infraware/filemanager/webstorage/syncmodel/SMemoSyncModel;

    return-object v0
.end method

.method static synthetic access$2(Lcom/infraware/filemanager/webstorage/SMemoSyncManager;)Ljava/util/ArrayList;
    .locals 1
    .parameter

    .prologue
    .line 49
    iget-object v0, p0, Lcom/infraware/filemanager/webstorage/SMemoSyncManager;->m_oLocalFileList:Ljava/util/ArrayList;

    return-object v0
.end method

.method static synthetic access$3(Lcom/infraware/filemanager/webstorage/SMemoSyncManager;)Ljava/util/ArrayList;
    .locals 1
    .parameter

    .prologue
    .line 48
    iget-object v0, p0, Lcom/infraware/filemanager/webstorage/SMemoSyncManager;->m_oWebFileList:Ljava/util/ArrayList;

    return-object v0
.end method

.method static synthetic access$4(Lcom/infraware/filemanager/webstorage/SMemoSyncManager;)Landroid/os/Handler;
    .locals 1
    .parameter

    .prologue
    .line 302
    iget-object v0, p0, Lcom/infraware/filemanager/webstorage/SMemoSyncManager;->m_oHandler:Landroid/os/Handler;

    return-object v0
.end method

.method static synthetic access$5(Lcom/infraware/filemanager/webstorage/SMemoSyncManager;Ljava/util/ArrayList;)V
    .locals 0
    .parameter
    .parameter
    ...
    .prologue
    .line 296
    invoke-direct {p0, p1}, Lcom/infraware/filemanager/webstorage/SMemoSyncManager;->fileDownIterator(Ljava/util/ArrayList;)V

    return-void
.end method

.method static synthetic access$6(Lcom/infraware/filemanager/webstorage/SMemoSyncManager;I)V
    .locals 0
    .parameter
    .parameter
    ...
    .prologue
    .line 291
    invoke-direct {p0, p1}, Lcom/infraware/filemanager/webstorage/SMemoSyncManager;->prepareSyncProgress(I)V
...
.method private clearList()V
    ...
    .line 82
    iget-object v0, p0, Lcom/infraware/filemanager/webstorage/SMemoSyncManager;->m_oWebRootFolerList:Ljava/util/ArrayList;
    ...
    invoke-virtual {v0}, Lcom/infraware/filemanager/webstorage/syncmodel/SMemoSyncModel;->clearData()V
...
.method private downloadProcess()Z
    ...
    .line 351
    iget-object v2, p0, Lcom/infraware/filemanager/webstorage/SMemoSyncManager;->m_oDownloadFileIter:Ljava/util/Iterator;
    ...
    .line 356
    iget-object v2, v0, Lcom/infraware/filemanager/FmFileItem;->m_strPath:Ljava/lang/String;

    invoke-static {v2}, Lcom/infraware/filemanager/webstorage/WebSyncUtil;->convertSMemoWebToLocal(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v3}, Lcom/infraware/filemanager/webstorage/WebSyncUtil;->removeSMemoLocalPrefix(Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 361
    sget-object v1, Lcom/infraware/filemanager/webstorage/SMemoSyncManager;->m_oThreadProvider:Lcom/infraware/filemanager/webstorage/SyncOperationThreadProvider;

    iget-object v2, p0, Lcom/infraware/filemanager/webstorage/SMemoSyncManager;->m_oActivity:Landroid/app/Activity;
...
.method private fileDownIterator(Ljava/util/ArrayList;)V
    .locals 1
    .parameter
    .annotation system Ldalvik/annotation/Signature;
        value = {
    ...
    iput-object v0, p0, Lcom/infraware/filemanager/webstorage/SMemoSyncManager;->m_oDownloadFileIter:Ljava/util/Iterator;
...
.method private fileProcess()Z
    ...
    .prologue
    .line 343
    invoke-direct {p0}, Lcom/infraware/filemanager/webstorage/SMemoSyncManager;->downloadProcess()Z
...
.method private finalizeProcess(ZI)V
    ...
    .line 95
    invoke-direct {p0}, Lcom/infraware/filemanager/webstorage/SMemoSyncManager;->clearList()V

    .line 97
    iput-object v1, p0, Lcom/infraware/filemanager/webstorage/SMemoSyncManager;->m_strID:Ljava/lang/String;

    .line 98
    iput-object v1, p0, Lcom/infraware/filemanager/webstorage/SMemoSyncManager;->m_strPW:Ljava/lang/String;

    .line 99
    const/4 v0, -0x1

    iput v0, p0, Lcom/infraware/filemanager/webstorage/SMemoSyncManager;->m_nServiceType:I

    .line 101
    invoke-direct {p0}, Lcom/infraware/filemanager/webstorage/SMemoSyncManager;->killCancelTimer()V
    ...
    .line 106
    iget-object v0, p0, Lcom/infraware/filemanager/webstorage/SMemoSyncManager;->m_oUpdateListener:Lcom/infraware/filemanager/webstorage/WebSyncManager$IUpdateListListener;
    ...
    .line 111
    iput-object v1, p0, Lcom/infraware/filemanager/webstorage/SMemoSyncManager;->m_oActivity:Landroid/app/Activity;

    .line 112
    return-void
.end method

.method private getAllChildList()Z
    .locals 6

    .prologue
    .line 276
    iget-object v1, p0, Lcom/infraware/filemanager/webstorage/SMemoSyncManager;->m_oWebRootFolderIter:Ljava/util/Iterator;

    if-nez v1, :cond_0

    .line 278
    iget-object v1, p0, Lcom/infraware/filemanager/webstorage/SMemoSyncManager;->m_oWebFileList:Ljava/util/ArrayList;

    invoke-virtual {v1}, Ljava/util/ArrayList;->clear()V

    .line 279
    iget-object v1, p0, Lcom/infraware/filemanager/webstorage/SMemoSyncManager;->m_oWebRootFolerList:Ljava/util/ArrayList;
    ...
    iget-object v5, p0, Lcom/infraware/filemanager/webstorage/SMemoSyncManager;->m_oWebFileList:Ljava/util/ArrayList;

    invoke-virtual {v1, v2, v3, v4, v5}, Lcom/infraware/filemanager/webstorage/SyncOperationThreadProvider;->getAllChildList(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Ljava/util/ArrayList;)Z
...
.method public static getInstance()Lcom/infraware/filemanager/webstorage/SMemoSyncManager;
    .locals 2

    .prologue
    .line 72
    sget-object v0, Lcom/infraware/filemanager/webstorage/SMemoSyncManager;->m_oThreadProvider:Lcom/infraware/filemanager/webstorage/SyncOperationThreadProvider;
    ...
    sget-object v1, Lcom/infraware/filemanager/webstorage/SMemoSyncManager;->INSTANCE:Lcom/infraware/filemanager/webstorage/SMemoSyncManager;
    ...
    sput-object v0, Lcom/infraware/filemanager/webstorage/SMemoSyncManager;->m_oThreadProvider:Lcom/infraware/filemanager/webstorage/SyncOperationThreadProvider;

    .line 75
    :cond_0
    sget-object v0, Lcom/infraware/filemanager/webstorage/SMemoSyncManager;->INSTANCE:Lcom/infraware/filemanager/webstorage/SMemoSyncManager;
...
.method private getLocalSyncFileList(Ljava/lang/String;)V
    ...
    .line 219
    iget-object v7, p0, Lcom/infraware/filemanager/webstorage/SMemoSyncManager;->m_oLocalFileList:Ljava/util/ArrayList;
    ...
    invoke-direct {p0, v7}, Lcom/infraware/filemanager/webstorage/SMemoSyncManager;->getLocalSyncFileList(Ljava/lang/String;)V
...
.method private getRootFileList()V
    ...
    iget-object v1, p0, Lcom/infraware/filemanager/webstorage/SMemoSyncManager;->m_oActivity:Landroid/app/Activity;

    const-string v2, "0"

    const-string v3, "/"

    iget-object v4, p0, Lcom/infraware/filemanager/webstorage/SMemoSyncManager;->m_oWebFileList:Ljava/util/ArrayList;
...
.method private killCancelTimer()V
    ...
    .line 411
    iget-object v0, p0, Lcom/infraware/filemanager/webstorage/SMemoSyncManager;->m_oCancelTimer:Ljava/util/Timer;
    ...
    .line 413
    :cond_0
    iget-object v0, p0, Lcom/infraware/filemanager/webstorage/SMemoSyncManager;->m_oCancelTimerTask:Ljava/util/TimerTask;
...
.method private makeSyncRootFolderList()Z
    .locals 6
    ...
    .line 248
    :pswitch_1
    iget-object v3, p0, Lcom/infraware/filemanager/webstorage/SMemoSyncManager;->m_oWebFileList:Ljava/util/ArrayList;
    ...
    const-string v5, "/SAMSUNG_S MEMO"
    ...
    .line 252
    iget-object v2, p0, Lcom/infraware/filemanager/webstorage/SMemoSyncManager;->m_oWebRootFolerList:Ljava/util/ArrayList;
    ...
    .line 265
    iget-object v3, p0, Lcom/infraware/filemanager/webstorage/SMemoSyncManager;->m_oWebRootFolerList:Ljava/util/ArrayList;
    ...
    iget-object v4, v0, Lcom/infraware/filemanager/FmFileItem;->m_strStack:Ljava/lang/String;
    ...
    .line 262
    iget-object v4, p0, Lcom/infraware/filemanager/webstorage/SMemoSyncManager;->m_oWebRootFolerList:Ljava/util/ArrayList;
...
.method private nextStep(ZI)V
    ...
    .line 424
    iget-object v1, p0, Lcom/infraware/filemanager/webstorage/SMemoSyncManager;->m_oHandler:Landroid/os/Handler;

    invoke-static {v1, v4, p2, v4}, Landroid/os/Message;->obtain(Landroid/os/Handler;III)Landroid/os/Message;
    ...
    .line 429
    :cond_1
    invoke-static {}, Lcom/infraware/filemanager/webstorage/SMemoSyncManager;->$SWITCH_TABLE$com$infraware$filemanager$webstorage$SMemoSyncManager$E_WEBSYNC_STEP()[I

    move-result-object v1

    iget-object v2, p0, Lcom/infraware/filemanager/webstorage/SMemoSyncManager;->m_eWebSyncStep:Lcom/infraware/filemanager/webstorage/SMemoSyncManager$E_WEBSYNC_STEP;

    invoke-virtual {v2}, Lcom/infraware/filemanager/webstorage/SMemoSyncManager$E_WEBSYNC_STEP;->ordinal()I
    ...
    iput-object v1, p0, Lcom/infraware/filemanager/webstorage/SMemoSyncManager;->m_eWebSyncStep:Lcom/infraware/filemanager/webstorage/SMemoSyncManager$E_WEBSYNC_STEP;

    .line 433
    invoke-direct {p0}, Lcom/infraware/filemanager/webstorage/SMemoSyncManager;->getRootFileList()V

    goto :goto_0

    .line 436
    :pswitch_1
    invoke-direct {p0}, Lcom/infraware/filemanager/webstorage/SMemoSyncManager;->makeSyncRootFolderList()Z
    ...
    .line 439
    invoke-direct {p0, v3, v4}, Lcom/infraware/filemanager/webstorage/SMemoSyncManager;->nextStep(ZI)V
    ...
    .line 444
    invoke-direct {p0, v3, v5}, Lcom/infraware/filemanager/webstorage/SMemoSyncManager;->nextStep(ZI)V

    goto :goto_0

    .line 448
    :pswitch_2
    invoke-direct {p0}, Lcom/infraware/filemanager/webstorage/SMemoSyncManager;->getAllChildList()Z
    ...
    .line 451
    invoke-direct {p0}, Lcom/infraware/filemanager/webstorage/SMemoSyncManager;->startSyncProcess()V

    goto :goto_0

    .line 455
    :pswitch_3
    invoke-direct {p0, p2}, Lcom/infraware/filemanager/webstorage/SMemoSyncManager;->updateProgress(I)V

    .line 456
    invoke-direct {p0}, Lcom/infraware/filemanager/webstorage/SMemoSyncManager;->syncProcess()Z
    ...
    .line 459
    invoke-direct {p0, v5}, Lcom/infraware/filemanager/webstorage/SMemoSyncManager;->updateProgress(I)V
    ...
    invoke-direct {p0, v1}, Lcom/infraware/filemanager/webstorage/SMemoSyncManager;->onToastText(Ljava/lang/String;)V

    .line 465
    invoke-direct {p0, v3, v3}, Lcom/infraware/filemanager/webstorage/SMemoSyncManager;->finalizeProcess(ZI)V
    ...
    invoke-direct {p0, v3, v1}, Lcom/infraware/filemanager/webstorage/SMemoSyncManager;->finalizeProcess(ZI)V
...
.method private onToastText(Ljava/lang/String;)V
    ...
    .prologue
    .line 565
    iget-object v0, p0, Lcom/infraware/filemanager/webstorage/SMemoSyncManager;->m_oActivity:Landroid/app/Activity;
    ...
    .line 567
    :cond_0
    iget-object v0, p0, Lcom/infraware/filemanager/webstorage/SMemoSyncManager;->m_oToast:Landroid/widget/Toast;
    ...
    iput-object v0, p0, Lcom/infraware/filemanager/webstorage/SMemoSyncManager;->m_oToast:Landroid/widget/Toast;
...
.method private prepareSyncProgress(I)V
    ...
    .prologue
    .line 293
    iput p1, p0, Lcom/infraware/filemanager/webstorage/SMemoSyncManager;->m_nMaxSyncCount:I
...
.method private setCancelTimer()V
    ...
    iput-object v0, p0, Lcom/infraware/filemanager/webstorage/SMemoSyncManager;->m_oCancelTimer:Ljava/util/Timer;

    .line 393
    new-instance v0, Lcom/infraware/filemanager/webstorage/SMemoSyncManager$3;

    invoke-direct {v0, p0}, Lcom/infraware/filemanager/webstorage/SMemoSyncManager$3;-><init>(Lcom/infraware/filemanager/webstorage/SMemoSyncManager;)V

    iput-object v0, p0, Lcom/infraware/filemanager/webstorage/SMemoSyncManager;->m_oCancelTimerTask:Ljava/util/TimerTask;

    .line 406
    iget-object v0, p0, Lcom/infraware/filemanager/webstorage/SMemoSyncManager;->m_oCancelTimer:Ljava/util/Timer;

    iget-object v1, p0, Lcom/infraware/filemanager/webstorage/SMemoSyncManager;->m_oCancelTimerTask:Ljava/util/TimerTask;
...
.method private startSyncProcess()V
    ...
    .prologue
    .line 312
    new-instance v0, Lcom/infraware/filemanager/webstorage/SMemoSyncManager$2;

    invoke-direct {v0, p0}, Lcom/infraware/filemanager/webstorage/SMemoSyncManager$2;-><init>(Lcom/infraware/filemanager/webstorage/SMemoSyncManager;)V
...
.method private syncProcess()Z
    ...
    .prologue
    .line 335
    invoke-direct {p0}, Lcom/infraware/filemanager/webstorage/SMemoSyncManager;->fileProcess()Z
...
.method private updateProgress(I)V
    ...
    .prologue
    .line 579
    iget v1, p0, Lcom/infraware/filemanager/webstorage/SMemoSyncManager;->m_nMaxSyncCount:I
    ...
    iget v2, p0, Lcom/infraware/filemanager/webstorage/SMemoSyncManager;->m_nMaxSyncCount:I
...
.method public cancelAction(Z)V
    ...
    .line 369
    iget v0, p0, Lcom/infraware/filemanager/webstorage/SMemoSyncManager;->m_nServiceType:I
    ...
    .line 375
    invoke-direct {p0}, Lcom/infraware/filemanager/webstorage/SMemoSyncManager;->setCancelTimer()V
    ...
    invoke-direct {p0, v1, v2}, Lcom/infraware/filemanager/webstorage/SMemoSyncManager;->finalizeProcess(ZI)V
...
.method public isProgress()Z
    ...
    .prologue
    .line 116
    iget-object v0, p0, Lcom/infraware/filemanager/webstorage/SMemoSyncManager;->m_eWebSyncStep:Lcom/infraware/filemanager/webstorage/SMemoSyncManager$E_WEBSYNC_STEP;
...
.method public login(Landroid/app/Activity;ILjava/lang/String;Ljava/lang/String;Lcom/infraware/filemanager/webstorage/WebSyncManager$IUpdateListListener;)Z
    ...
    sget-object v3, Lcom/infraware/filemanager/webstorage/SMemoSyncManager$E_WEBSYNC_STEP;->eWEBSYNC_STEP_IDLE:Lcom/infraware/filemanager/webstorage/SMemoSyncManager$E_WEBSYNC_STEP;
    ...
    .line 128
    :cond_0
    iput-object p1, p0, Lcom/infraware/filemanager/webstorage/SMemoSyncManager;->m_oActivity:Landroid/app/Activity;
    ...
    invoke-direct {p0, v0}, Lcom/infraware/filemanager/webstorage/SMemoSyncManager;->onToastText(Ljava/lang/String;)V

    .line 132
    const/4 v0, 0x0

    iput-object v0, p0, Lcom/infraware/filemanager/webstorage/SMemoSyncManager;->m_oActivity:Landroid/app/Activity;
    ...
    .line 136
    :cond_1
    iput-object p3, p0, Lcom/infraware/filemanager/webstorage/SMemoSyncManager;->m_strID:Ljava/lang/String;

    .line 137
    iput-object p4, p0, Lcom/infraware/filemanager/webstorage/SMemoSyncManager;->m_strPW:Ljava/lang/String;

    .line 138
    iput p2, p0, Lcom/infraware/filemanager/webstorage/SMemoSyncManager;->m_nServiceType:I

    .line 140
    iput-object p5, p0, Lcom/infraware/filemanager/webstorage/SMemoSyncManager;->m_oUpdateListener:Lcom/infraware/filemanager/webstorage/WebSyncManager$IUpdateListListener;
    ...
    .line 148
    iget v1, p0, Lcom/infraware/filemanager/webstorage/SMemoSyncManager;->m_nServiceType:I

    iget-object v2, p0, Lcom/infraware/filemanager/webstorage/SMemoSyncManager;->m_strID:Ljava/lang/String;

    iget-object v3, p0, Lcom/infraware/filemanager/webstorage/SMemoSyncManager;->m_strPW:Ljava/lang/String;

    invoke-direct {p0, v1, v2, v3}, Lcom/infraware/filemanager/webstorage/SMemoSyncManager;->login(ILjava/lang/String;Ljava/lang/String;)V
...
.method public varargs onCommand(Lcom/infraware/uxcontrol/uiunit/UiUnitView;Lcom/infraware/uxcontrol/uiunit/UiEnum$EUnitCommand;[Ljava/lang/Object;)V
    ...
    .prologue
    .line 595
    invoke-static {}, Lcom/infraware/filemanager/webstorage/SMemoSyncManager;->$SWITCH_TABLE$com$infraware$uxcontrol$uiunit$UiEnum$EUnitCommand()[I
    ...
    invoke-virtual {p0, v0}, Lcom/infraware/filemanager/webstorage/SMemoSyncManager;->cancelAction(Z)V
...
.method public onResult(III)V
    ...
    .line 488
    :sswitch_0
    iget v2, p0, Lcom/infraware/filemanager/webstorage/SMemoSyncManager;->m_nServiceType:I

    iget-object v3, p0, Lcom/infraware/filemanager/webstorage/SMemoSyncManager;->m_strID:Ljava/lang/String;

    iget-object v4, p0, Lcom/infraware/filemanager/webstorage/SMemoSyncManager;->m_strPW:Ljava/lang/String;
    ...
    .line 490
    invoke-direct {p0, v5, v6}, Lcom/infraware/filemanager/webstorage/SMemoSyncManager;->finalizeProcess(ZI)V

    .line 491
    iget-object v2, p0, Lcom/infraware/filemanager/webstorage/SMemoSyncManager;->m_oUpdateListener:Lcom/infraware/filemanager/webstorage/WebSyncManager$IUpdateListListener;
    ...
    .line 495
    :sswitch_1
    invoke-direct {p0, v5, v5}, Lcom/infraware/filemanager/webstorage/SMemoSyncManager;->nextStep(ZI)V

    goto :goto_0

    .line 498
    :sswitch_2
    invoke-direct {p0, v5, v6}, Lcom/infraware/filemanager/webstorage/SMemoSyncManager;->nextStep(ZI)V
    ...
    .line 560
    :cond_5
    invoke-direct {p0, v0, p3}, Lcom/infraware/filemanager/webstorage/SMemoSyncManager;->finalizeProcess(ZI)V
    ...
    iget v3, p0, Lcom/infraware/filemanager/webstorage/SMemoSyncManager;->m_nServiceType:I
...
.method public startSync(Landroid/app/Activity;ILjava/lang/String;Ljava/lang/String;Ljava/util/List;Lcom/infraware/filemanager/webstorage/WebSyncManager$IUpdateListListener;)Z
    ...
    .line 155
    iget-object v4, p0, Lcom/infraware/filemanager/webstorage/SMemoSyncManager;->m_eWebSyncStep:Lcom/infraware/filemanager/webstorage/SMemoSyncManager$E_WEBSYNC_STEP;

    sget-object v5, Lcom/infraware/filemanager/webstorage/SMemoSyncManager$E_WEBSYNC_STEP;->eWEBSYNC_STEP_IDLE:Lcom/infraware/filemanager/webstorage/SMemoSyncManager$E_WEBSYNC_STEP;
    ...
    sget v5, Lcom/infraware/uxcontrol/uicontrol/common/UiNetworkConnection;->DISCONNECTED:I
    ...
    invoke-direct {p0, v2}, Lcom/infraware/filemanager/webstorage/SMemoSyncManager;->onToastText(Ljava/lang/String;)V

    .line 164
    const/4 v2, 0x0

    iput-object v2, p0, Lcom/infraware/filemanager/webstorage/SMemoSyncManager;->m_oActivity:Landroid/app/Activity;
    ...
    .line 172
    iput-object p6, p0, Lcom/infraware/filemanager/webstorage/SMemoSyncManager;->m_oUpdateListener:Lcom/infraware/filemanager/webstorage/WebSyncManager$IUpdateListListener;
    ...
    .line 177
    iget-boolean v4, p0, Lcom/infraware/filemanager/webstorage/SMemoSyncManager;->m_bShowProgressUI:Z

    if-eqz v4, :cond_4

    iget-object v4, p0, Lcom/infraware/filemanager/webstorage/SMemoSyncManager;->m_oActivity:Landroid/app/Activity;

    invoke-static {v4, v3, v6, v3}, Lcom/infraware/filemanager/FmFileProgress;->startTransferProgress(Landroid/content/Context;III)V
    ...
    iget v4, p0, Lcom/infraware/filemanager/webstorage/SMemoSyncManager;->m_nServiceType:I
    ...
    .line 189
    .local v0, oRootFile:Ljava/io/File;
    ...
    .line 191
    :cond_3
    invoke-direct {p0, v1}, Lcom/infraware/filemanager/webstorage/SMemoSyncManager;->getLocalSyncFileList(Ljava/lang/String;)V

    .line 193
    sget-object v4, Lcom/infraware/filemanager/webstorage/SMemoSyncManager$E_WEBSYNC_STEP;->eWEBSYNC_STEP_READY:Lcom/infraware/filemanager/webstorage/SMemoSyncManager$E_WEBSYNC_STEP;

    iput-object v4, p0, Lcom/infraware/filemanager/webstorage/SMemoSyncManager;->m_eWebSyncStep:Lcom/infraware/filemanager/webstorage/SMemoSyncManager$E_WEBSYNC_STEP;

    .line 194
    invoke-direct {p0, v3, v3}, Lcom/infraware/filemanager/webstorage/SMemoSyncManager;->nextStep(ZI)V

    goto :goto_0

    .line 178
    .end local v0           #oRootFile:Ljava/io/File;
    .end local v1           #strPath:Ljava/lang/String;
    :cond_4
    iget-object v4, p0, Lcom/infraware/filemanager/webstorage/SMemoSyncManager;->m_oActivity:Landroid/app/Activity;

    invoke-static {v4, v3, v6}, Lcom/infraware/filemanager/FmFileProgress;->startProgress(Landroid/content/Context;II)V
