.class public Lcom/evernote/edam/notestore/NoteStore$AsyncClient$getLinkedNotebookSyncState_call;
...
.annotation system Ldalvik/annotation/InnerClass;
    accessFlags = 0x9
    name = "getLinkedNotebookSyncState_call"
.end annotation
...
.method public constructor <init>(Ljava/lang/String;Lcom/evernote/edam/type/LinkedNotebook;Lorg/apache/thrift/async/AsyncMethodCallback;Lorg/apache/thrift/async/TAsyncClient;Lorg/apache/thrift/protocol/TProtocolFactory;Lorg/apache/thrift/transport/TNonblockingTransport;)V
    ...
    .line 3744
    iput-object p1, p0, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$getLinkedNotebookSyncState_call;->authenticationToken:Ljava/lang/String;

    .line 3745
    iput-object p2, p0, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$getLinkedNotebookSyncState_call;->linkedNotebook:Lcom/evernote/edam/type/LinkedNotebook;
...
# virtual methods
.method public getResult()Lcom/evernote/edam/notestore/SyncState;
    .locals 4
    .annotation system Ldalvik/annotation/Throws;
        value = {
    ...
    .prologue
    .line 3758
    invoke-virtual {p0}, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$getLinkedNotebookSyncState_call;->getState()Lorg/apache/thrift/async/TAsyncMethodCall$State;
    ...
    invoke-virtual {p0}, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$getLinkedNotebookSyncState_call;->getFrameBuffer()Ljava/nio/ByteBuffer;
    ...
    iget-object v2, p0, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$getLinkedNotebookSyncState_call;->client:Lorg/apache/thrift/async/TAsyncClient;
    ...
    invoke-virtual {v2}, Lcom/evernote/edam/notestore/NoteStore$Client;->recv_getLinkedNotebookSyncState()Lcom/evernote/edam/notestore/SyncState;
...
.method public write_args(Lorg/apache/thrift/protocol/TProtocol;)V
    ...
    iget-object v1, p0, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$getLinkedNotebookSyncState_call;->authenticationToken:Ljava/lang/String;

    invoke-virtual {v0, v1}, Lcom/evernote/edam/notestore/NoteStore$getLinkedNotebookSyncState_args;->setAuthenticationToken(Ljava/lang/String;)V

    .line 3752
    iget-object v1, p0, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$getLinkedNotebookSyncState_call;->linkedNotebook:Lcom/evernote/edam/type/LinkedNotebook;

    invoke-virtual {v0, v1}, Lcom/evernote/edam/notestore/NoteStore$getLinkedNotebookSyncState_args;->setLinkedNotebook(Lcom/evernote/edam/type/LinkedNotebook;)V

    .line 3753
    invoke-virtual {v0, p1}, Lcom/evernote/edam/notestore/NoteStore$getLinkedNotebookSyncState_args;->write(Lorg/apache/thrift/protocol/TProtocol;)V
