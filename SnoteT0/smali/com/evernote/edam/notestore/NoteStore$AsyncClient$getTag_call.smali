.class public Lcom/evernote/edam/notestore/NoteStore$AsyncClient$getTag_call;
...
.method public constructor <init>(Ljava/lang/String;Ljava/lang/String;Lorg/apache/thrift/async/AsyncMethodCallback;Lorg/apache/thrift/async/TAsyncClient;Lorg/apache/thrift/protocol/TProtocolFactory;Lorg/apache/thrift/transport/TNonblockingTransport;)V
    ...
    .line 4084
    iput-object p1, p0, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$getTag_call;->authenticationToken:Ljava/lang/String;

    .line 4085
    iput-object p2, p0, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$getTag_call;->guid:Ljava/lang/String;
...
.method public getResult()Lcom/evernote/edam/type/Tag;
    ...
    .prologue
    .line 4098
    invoke-virtual {p0}, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$getTag_call;->getState()Lorg/apache/thrift/async/TAsyncMethodCall$State;
    ...
    invoke-virtual {p0}, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$getTag_call;->getFrameBuffer()Ljava/nio/ByteBuffer;
    ...
    iget-object v2, p0, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$getTag_call;->client:Lorg/apache/thrift/async/TAsyncClient;
    ...
    invoke-virtual {v2}, Lcom/evernote/edam/notestore/NoteStore$Client;->recv_getTag()Lcom/evernote/edam/type/Tag;
...
.method public write_args(Lorg/apache/thrift/protocol/TProtocol;)V
    ...
    iget-object v1, p0, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$getTag_call;->authenticationToken:Ljava/lang/String;

    invoke-virtual {v0, v1}, Lcom/evernote/edam/notestore/NoteStore$getTag_args;->setAuthenticationToken(Ljava/lang/String;)V

    .line 4092
    iget-object v1, p0, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$getTag_call;->guid:Ljava/lang/String;

    invoke-virtual {v0, v1}, Lcom/evernote/edam/notestore/NoteStore$getTag_args;->setGuid(Ljava/lang/String;)V

    .line 4093
    invoke-virtual {v0, p1}, Lcom/evernote/edam/notestore/NoteStore$getTag_args;->write(Lorg/apache/thrift/protocol/TProtocol;)V
