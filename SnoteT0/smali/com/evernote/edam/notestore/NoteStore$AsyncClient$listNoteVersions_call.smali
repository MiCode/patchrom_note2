.class public Lcom/evernote/edam/notestore/NoteStore$AsyncClient$listNoteVersions_call;
...
.method public constructor <init>(Ljava/lang/String;Ljava/lang/String;Lorg/apache/thrift/async/AsyncMethodCallback;Lorg/apache/thrift/async/TAsyncClient;Lorg/apache/thrift/protocol/TProtocolFactory;Lorg/apache/thrift/transport/TNonblockingTransport;)V
    ...
    .line 5152
    iput-object p1, p0, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$listNoteVersions_call;->authenticationToken:Ljava/lang/String;

    .line 5153
    iput-object p2, p0, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$listNoteVersions_call;->noteGuid:Ljava/lang/String;
...
.method public getResult()Ljava/util/List;
    ...
    .prologue
    .line 5166
    invoke-virtual {p0}, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$listNoteVersions_call;->getState()Lorg/apache/thrift/async/TAsyncMethodCall$State;
    ...
    invoke-virtual {p0}, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$listNoteVersions_call;->getFrameBuffer()Ljava/nio/ByteBuffer;
    ...
    iget-object v2, p0, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$listNoteVersions_call;->client:Lorg/apache/thrift/async/TAsyncClient;
    ...
    invoke-virtual {v2}, Lcom/evernote/edam/notestore/NoteStore$Client;->recv_listNoteVersions()Ljava/util/List;
...
.method public write_args(Lorg/apache/thrift/protocol/TProtocol;)V
    ...
    iget-object v1, p0, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$listNoteVersions_call;->authenticationToken:Ljava/lang/String;

    invoke-virtual {v0, v1}, Lcom/evernote/edam/notestore/NoteStore$listNoteVersions_args;->setAuthenticationToken(Ljava/lang/String;)V

    .line 5160
    iget-object v1, p0, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$listNoteVersions_call;->noteGuid:Ljava/lang/String;

    invoke-virtual {v0, v1}, Lcom/evernote/edam/notestore/NoteStore$listNoteVersions_args;->setNoteGuid(Ljava/lang/String;)V

    .line 5161
    invoke-virtual {v0, p1}, Lcom/evernote/edam/notestore/NoteStore$listNoteVersions_args;->write(Lorg/apache/thrift/protocol/TProtocol;)V
