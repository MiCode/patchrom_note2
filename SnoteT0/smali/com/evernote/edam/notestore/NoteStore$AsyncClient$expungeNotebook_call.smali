.class public Lcom/evernote/edam/notestore/NoteStore$AsyncClient$expungeNotebook_call;
...
.method public constructor <init>(Ljava/lang/String;Ljava/lang/String;Lorg/apache/thrift/async/AsyncMethodCallback;Lorg/apache/thrift/async/TAsyncClient;Lorg/apache/thrift/protocol/TProtocolFactory;Lorg/apache/thrift/transport/TNonblockingTransport;)V
    ...
    .line 3985
    iput-object p1, p0, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$expungeNotebook_call;->authenticationToken:Ljava/lang/String;

    .line 3986
    iput-object p2, p0, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$expungeNotebook_call;->guid:Ljava/lang/String;
...
.method public getResult()I
    ...
    .prologue
    .line 3999
    invoke-virtual {p0}, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$expungeNotebook_call;->getState()Lorg/apache/thrift/async/TAsyncMethodCall$State;
    ...
    invoke-virtual {p0}, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$expungeNotebook_call;->getFrameBuffer()Ljava/nio/ByteBuffer;
    ...
    iget-object v2, p0, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$expungeNotebook_call;->client:Lorg/apache/thrift/async/TAsyncClient;
    ...
    invoke-virtual {v2}, Lcom/evernote/edam/notestore/NoteStore$Client;->recv_expungeNotebook()I
...
.method public write_args(Lorg/apache/thrift/protocol/TProtocol;)V
    ...
    iget-object v1, p0, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$expungeNotebook_call;->authenticationToken:Ljava/lang/String;

    invoke-virtual {v0, v1}, Lcom/evernote/edam/notestore/NoteStore$expungeNotebook_args;->setAuthenticationToken(Ljava/lang/String;)V

    .line 3993
    iget-object v1, p0, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$expungeNotebook_call;->guid:Ljava/lang/String;

    invoke-virtual {v0, v1}, Lcom/evernote/edam/notestore/NoteStore$expungeNotebook_args;->setGuid(Ljava/lang/String;)V

    .line 3994
    invoke-virtual {v0, p1}, Lcom/evernote/edam/notestore/NoteStore$expungeNotebook_args;->write(Lorg/apache/thrift/protocol/TProtocol;)V
