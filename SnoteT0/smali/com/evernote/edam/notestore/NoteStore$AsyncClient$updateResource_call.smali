.class public Lcom/evernote/edam/notestore/NoteStore$AsyncClient$updateResource_call;
...
# direct methods
.method public constructor <init>(Ljava/lang/String;Lcom/evernote/edam/type/Resource;Lorg/apache/thrift/async/AsyncMethodCallback;Lorg/apache/thrift/async/TAsyncClient;Lorg/apache/thrift/protocol/TProtocolFactory;Lorg/apache/thrift/transport/TNonblockingTransport;)V
    .locals 6
    ...
    .line 5426
    iput-object p1, p0, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$updateResource_call;->authenticationToken:Ljava/lang/String;

    .line 5427
    iput-object p2, p0, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$updateResource_call;->resource:Lcom/evernote/edam/type/Resource;
...
.method public getResult()I
    ...
    .prologue
    .line 5440
    invoke-virtual {p0}, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$updateResource_call;->getState()Lorg/apache/thrift/async/TAsyncMethodCall$State;
    ...
    invoke-virtual {p0}, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$updateResource_call;->getFrameBuffer()Ljava/nio/ByteBuffer;
    ...
    iget-object v2, p0, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$updateResource_call;->client:Lorg/apache/thrift/async/TAsyncClient;
    ...
    invoke-virtual {v2}, Lcom/evernote/edam/notestore/NoteStore$Client;->recv_updateResource()I
...
.method public write_args(Lorg/apache/thrift/protocol/TProtocol;)V
    ...
    iget-object v1, p0, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$updateResource_call;->authenticationToken:Ljava/lang/String;

    invoke-virtual {v0, v1}, Lcom/evernote/edam/notestore/NoteStore$updateResource_args;->setAuthenticationToken(Ljava/lang/String;)V

    .line 5434
    iget-object v1, p0, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$updateResource_call;->resource:Lcom/evernote/edam/type/Resource;

    invoke-virtual {v0, v1}, Lcom/evernote/edam/notestore/NoteStore$updateResource_args;->setResource(Lcom/evernote/edam/type/Resource;)V

    .line 5435
    invoke-virtual {v0, p1}, Lcom/evernote/edam/notestore/NoteStore$updateResource_args;->write(Lorg/apache/thrift/protocol/TProtocol;)V
