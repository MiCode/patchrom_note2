.class public Lcom/evernote/edam/notestore/NoteStore$AsyncClient$createNotebook_call;
...
# direct methods
.method public constructor <init>(Ljava/lang/String;Lcom/evernote/edam/type/Notebook;Lorg/apache/thrift/async/AsyncMethodCallback;Lorg/apache/thrift/async/TAsyncClient;Lorg/apache/thrift/protocol/TProtocolFactory;Lorg/apache/thrift/transport/TNonblockingTransport;)V
    .locals 6
    ...
    .line 3917
    iput-object p1, p0, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$createNotebook_call;->authenticationToken:Ljava/lang/String;

    .line 3918
    iput-object p2, p0, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$createNotebook_call;->notebook:Lcom/evernote/edam/type/Notebook;
...
.method public getResult()Lcom/evernote/edam/type/Notebook;
    ...
    .prologue
    .line 3931
    invoke-virtual {p0}, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$createNotebook_call;->getState()Lorg/apache/thrift/async/TAsyncMethodCall$State;
    ...
    invoke-virtual {p0}, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$createNotebook_call;->getFrameBuffer()Ljava/nio/ByteBuffer;
    ...
    iget-object v2, p0, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$createNotebook_call;->client:Lorg/apache/thrift/async/TAsyncClient;
    ...
    invoke-virtual {v2}, Lcom/evernote/edam/notestore/NoteStore$Client;->recv_createNotebook()Lcom/evernote/edam/type/Notebook;
...
.method public write_args(Lorg/apache/thrift/protocol/TProtocol;)V
    ...
    iget-object v1, p0, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$createNotebook_call;->authenticationToken:Ljava/lang/String;

    invoke-virtual {v0, v1}, Lcom/evernote/edam/notestore/NoteStore$createNotebook_args;->setAuthenticationToken(Ljava/lang/String;)V

    .line 3925
    iget-object v1, p0, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$createNotebook_call;->notebook:Lcom/evernote/edam/type/Notebook;

    invoke-virtual {v0, v1}, Lcom/evernote/edam/notestore/NoteStore$createNotebook_args;->setNotebook(Lcom/evernote/edam/type/Notebook;)V

    .line 3926
    invoke-virtual {v0, p1}, Lcom/evernote/edam/notestore/NoteStore$createNotebook_args;->write(Lorg/apache/thrift/protocol/TProtocol;)V
