.class public Lcom/evernote/edam/notestore/NoteStore$AsyncClient$getNoteApplicationData_call;
...
.annotation system Ldalvik/annotation/InnerClass;
    accessFlags = 0x9
    name = "getNoteApplicationData_call"
.end annotation
...
.method public constructor <init>(Ljava/lang/String;Ljava/lang/String;Lorg/apache/thrift/async/AsyncMethodCallback;Lorg/apache/thrift/async/TAsyncClient;Lorg/apache/thrift/protocol/TProtocolFactory;Lorg/apache/thrift/transport/TNonblockingTransport;)V
    ...
    .line 4624
    iput-object p1, p0, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$getNoteApplicationData_call;->authenticationToken:Ljava/lang/String;

    .line 4625
    iput-object p2, p0, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$getNoteApplicationData_call;->guid:Ljava/lang/String;
...
.method public getResult()Lcom/evernote/edam/type/LazyMap;
    ...
    .prologue
    .line 4638
    invoke-virtual {p0}, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$getNoteApplicationData_call;->getState()Lorg/apache/thrift/async/TAsyncMethodCall$State;
    ...
    invoke-virtual {p0}, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$getNoteApplicationData_call;->getFrameBuffer()Ljava/nio/ByteBuffer;
    ...
    iget-object v2, p0, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$getNoteApplicationData_call;->client:Lorg/apache/thrift/async/TAsyncClient;
    ...
    invoke-virtual {v2}, Lcom/evernote/edam/notestore/NoteStore$Client;->recv_getNoteApplicationData()Lcom/evernote/edam/type/LazyMap;
...
.method public write_args(Lorg/apache/thrift/protocol/TProtocol;)V
    ...
    iget-object v1, p0, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$getNoteApplicationData_call;->authenticationToken:Ljava/lang/String;

    invoke-virtual {v0, v1}, Lcom/evernote/edam/notestore/NoteStore$getNoteApplicationData_args;->setAuthenticationToken(Ljava/lang/String;)V

    .line 4632
    iget-object v1, p0, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$getNoteApplicationData_call;->guid:Ljava/lang/String;

    invoke-virtual {v0, v1}, Lcom/evernote/edam/notestore/NoteStore$getNoteApplicationData_args;->setGuid(Ljava/lang/String;)V

    .line 4633
    invoke-virtual {v0, p1}, Lcom/evernote/edam/notestore/NoteStore$getNoteApplicationData_args;->write(Lorg/apache/thrift/protocol/TProtocol;)V
