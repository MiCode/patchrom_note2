.class public Lcom/evernote/edam/notestore/NoteStore$AsyncClient$getResourceApplicationData_call;
...
.annotation system Ldalvik/annotation/InnerClass;
    accessFlags = 0x9
    name = "getResourceApplicationData_call"
.end annotation
...
.method public constructor <init>(Ljava/lang/String;Ljava/lang/String;Lorg/apache/thrift/async/AsyncMethodCallback;Lorg/apache/thrift/async/TAsyncClient;Lorg/apache/thrift/protocol/TProtocolFactory;Lorg/apache/thrift/transport/TNonblockingTransport;)V
    ...
    .line 5278
    iput-object p1, p0, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$getResourceApplicationData_call;->authenticationToken:Ljava/lang/String;

    .line 5279
    iput-object p2, p0, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$getResourceApplicationData_call;->guid:Ljava/lang/String;
...
# virtual methods
.method public getResult()Lcom/evernote/edam/type/LazyMap;
    .locals 4
    .annotation system Ldalvik/annotation/Throws;
        value = {
    ...
    .prologue
    .line 5292
    invoke-virtual {p0}, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$getResourceApplicationData_call;->getState()Lorg/apache/thrift/async/TAsyncMethodCall$State;
    ...
    invoke-virtual {p0}, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$getResourceApplicationData_call;->getFrameBuffer()Ljava/nio/ByteBuffer;
    ...
    iget-object v2, p0, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$getResourceApplicationData_call;->client:Lorg/apache/thrift/async/TAsyncClient;
    ...
    invoke-virtual {v2}, Lcom/evernote/edam/notestore/NoteStore$Client;->recv_getResourceApplicationData()Lcom/evernote/edam/type/LazyMap;
...
.method public write_args(Lorg/apache/thrift/protocol/TProtocol;)V
    ...
    iget-object v1, p0, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$getResourceApplicationData_call;->authenticationToken:Ljava/lang/String;

    invoke-virtual {v0, v1}, Lcom/evernote/edam/notestore/NoteStore$getResourceApplicationData_args;->setAuthenticationToken(Ljava/lang/String;)V

    .line 5286
    iget-object v1, p0, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$getResourceApplicationData_call;->guid:Ljava/lang/String;

    invoke-virtual {v0, v1}, Lcom/evernote/edam/notestore/NoteStore$getResourceApplicationData_args;->setGuid(Ljava/lang/String;)V

    .line 5287
    invoke-virtual {v0, p1}, Lcom/evernote/edam/notestore/NoteStore$getResourceApplicationData_args;->write(Lorg/apache/thrift/protocol/TProtocol;)V
