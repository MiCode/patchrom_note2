.class public Lcom/evernote/edam/notestore/NoteStore$AsyncClient$updateSearch_call;
...
.method public constructor <init>(Ljava/lang/String;Lcom/evernote/edam/type/SavedSearch;Lorg/apache/thrift/async/AsyncMethodCallback;Lorg/apache/thrift/async/TAsyncClient;Lorg/apache/thrift/protocol/TProtocolFactory;Lorg/apache/thrift/transport/TNonblockingTransport;)V
    ...
    .line 4353
    iput-object p1, p0, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$updateSearch_call;->authenticationToken:Ljava/lang/String;

    .line 4354
    iput-object p2, p0, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$updateSearch_call;->search:Lcom/evernote/edam/type/SavedSearch;
...
.method public getResult()I
    ...
    .prologue
    .line 4367
    invoke-virtual {p0}, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$updateSearch_call;->getState()Lorg/apache/thrift/async/TAsyncMethodCall$State;
    ...
    invoke-virtual {p0}, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$updateSearch_call;->getFrameBuffer()Ljava/nio/ByteBuffer;
    ...
    iget-object v2, p0, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$updateSearch_call;->client:Lorg/apache/thrift/async/TAsyncClient;
    ...
    invoke-virtual {v2}, Lcom/evernote/edam/notestore/NoteStore$Client;->recv_updateSearch()I
...
.method public write_args(Lorg/apache/thrift/protocol/TProtocol;)V
    ...
    iget-object v1, p0, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$updateSearch_call;->authenticationToken:Ljava/lang/String;

    invoke-virtual {v0, v1}, Lcom/evernote/edam/notestore/NoteStore$updateSearch_args;->setAuthenticationToken(Ljava/lang/String;)V

    .line 4361
    iget-object v1, p0, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$updateSearch_call;->search:Lcom/evernote/edam/type/SavedSearch;

    invoke-virtual {v0, v1}, Lcom/evernote/edam/notestore/NoteStore$updateSearch_args;->setSearch(Lcom/evernote/edam/type/SavedSearch;)V

    .line 4362
    invoke-virtual {v0, p1}, Lcom/evernote/edam/notestore/NoteStore$updateSearch_args;->write(Lorg/apache/thrift/protocol/TProtocol;)V
