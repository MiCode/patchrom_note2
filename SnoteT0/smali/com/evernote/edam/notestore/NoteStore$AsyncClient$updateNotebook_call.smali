.class public Lcom/evernote/edam/notestore/NoteStore$AsyncClient$updateNotebook_call;
...
.method public constructor <init>(Ljava/lang/String;Lcom/evernote/edam/type/Notebook;Lorg/apache/thrift/async/AsyncMethodCallback;Lorg/apache/thrift/async/TAsyncClient;Lorg/apache/thrift/protocol/TProtocolFactory;Lorg/apache/thrift/transport/TNonblockingTransport;)V
    ...
    .line 3951
    iput-object p1, p0, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$updateNotebook_call;->authenticationToken:Ljava/lang/String;

    .line 3952
    iput-object p2, p0, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$updateNotebook_call;->notebook:Lcom/evernote/edam/type/Notebook;
...
.method public getResult()I
    ...
    .prologue
    .line 3965
    invoke-virtual {p0}, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$updateNotebook_call;->getState()Lorg/apache/thrift/async/TAsyncMethodCall$State;
    ...
    invoke-virtual {p0}, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$updateNotebook_call;->getFrameBuffer()Ljava/nio/ByteBuffer;
    ...
    iget-object v2, p0, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$updateNotebook_call;->client:Lorg/apache/thrift/async/TAsyncClient;
    ...
    invoke-virtual {v2}, Lcom/evernote/edam/notestore/NoteStore$Client;->recv_updateNotebook()I
...
.method public write_args(Lorg/apache/thrift/protocol/TProtocol;)V
    ...
    iget-object v1, p0, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$updateNotebook_call;->authenticationToken:Ljava/lang/String;

    invoke-virtual {v0, v1}, Lcom/evernote/edam/notestore/NoteStore$updateNotebook_args;->setAuthenticationToken(Ljava/lang/String;)V

    .line 3959
    iget-object v1, p0, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$updateNotebook_call;->notebook:Lcom/evernote/edam/type/Notebook;

    invoke-virtual {v0, v1}, Lcom/evernote/edam/notestore/NoteStore$updateNotebook_args;->setNotebook(Lcom/evernote/edam/type/Notebook;)V

    .line 3960
    invoke-virtual {v0, p1}, Lcom/evernote/edam/notestore/NoteStore$updateNotebook_args;->write(Lorg/apache/thrift/protocol/TProtocol;)V
