.class public Lcom/evernote/edam/notestore/NoteStore$AsyncClient$updateNote_call;
...
.method public constructor <init>(Ljava/lang/String;Lcom/evernote/edam/type/Note;Lorg/apache/thrift/async/AsyncMethodCallback;Lorg/apache/thrift/async/TAsyncClient;Lorg/apache/thrift/protocol/TProtocolFactory;Lorg/apache/thrift/transport/TNonblockingTransport;)V
    ...
    .line 4948
    iput-object p1, p0, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$updateNote_call;->authenticationToken:Ljava/lang/String;

    .line 4949
    iput-object p2, p0, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$updateNote_call;->note:Lcom/evernote/edam/type/Note;
...
.method public getResult()Lcom/evernote/edam/type/Note;
    ...
    .prologue
    .line 4962
    invoke-virtual {p0}, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$updateNote_call;->getState()Lorg/apache/thrift/async/TAsyncMethodCall$State;
    ...
    invoke-virtual {p0}, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$updateNote_call;->getFrameBuffer()Ljava/nio/ByteBuffer;
    ...
    iget-object v2, p0, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$updateNote_call;->client:Lorg/apache/thrift/async/TAsyncClient;
    ...
    invoke-virtual {v2}, Lcom/evernote/edam/notestore/NoteStore$Client;->recv_updateNote()Lcom/evernote/edam/type/Note;
...
.method public write_args(Lorg/apache/thrift/protocol/TProtocol;)V
    ...
    iget-object v1, p0, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$updateNote_call;->authenticationToken:Ljava/lang/String;

    invoke-virtual {v0, v1}, Lcom/evernote/edam/notestore/NoteStore$updateNote_args;->setAuthenticationToken(Ljava/lang/String;)V

    .line 4956
    iget-object v1, p0, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$updateNote_call;->note:Lcom/evernote/edam/type/Note;

    invoke-virtual {v0, v1}, Lcom/evernote/edam/notestore/NoteStore$updateNote_args;->setNote(Lcom/evernote/edam/type/Note;)V

    .line 4957
    invoke-virtual {v0, p1}, Lcom/evernote/edam/notestore/NoteStore$updateNote_args;->write(Lorg/apache/thrift/protocol/TProtocol;)V
