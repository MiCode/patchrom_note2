.class public Lcom/evernote/edam/notestore/NoteStore$AsyncClient$getAccountSize_call;
...
.method public constructor <init>(Ljava/lang/String;Lorg/apache/thrift/async/AsyncMethodCallback;Lorg/apache/thrift/async/TAsyncClient;Lorg/apache/thrift/protocol/TProtocolFactory;Lorg/apache/thrift/transport/TNonblockingTransport;)V
    ...
    .line 5641
    iput-object p1, p0, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$getAccountSize_call;->authenticationToken:Ljava/lang/String;
...
.method public getResult()J
    ...
    .prologue
    .line 5653
    invoke-virtual {p0}, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$getAccountSize_call;->getState()Lorg/apache/thrift/async/TAsyncMethodCall$State;
    ...
    invoke-virtual {p0}, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$getAccountSize_call;->getFrameBuffer()Ljava/nio/ByteBuffer;
    ...
    iget-object v2, p0, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$getAccountSize_call;->client:Lorg/apache/thrift/async/TAsyncClient;
    ...
    invoke-virtual {v2}, Lcom/evernote/edam/notestore/NoteStore$Client;->recv_getAccountSize()J
...
.method public write_args(Lorg/apache/thrift/protocol/TProtocol;)V
    ...
    const-string v2, "getAccountSize"
    ...
    iget-object v1, p0, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$getAccountSize_call;->authenticationToken:Ljava/lang/String;

    invoke-virtual {v0, v1}, Lcom/evernote/edam/notestore/NoteStore$getAccountSize_args;->setAuthenticationToken(Ljava/lang/String;)V

    .line 5648
    invoke-virtual {v0, p1}, Lcom/evernote/edam/notestore/NoteStore$getAccountSize_args;->write(Lorg/apache/thrift/protocol/TProtocol;)V
