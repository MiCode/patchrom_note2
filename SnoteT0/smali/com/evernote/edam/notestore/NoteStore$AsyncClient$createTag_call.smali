.class public Lcom/evernote/edam/notestore/NoteStore$AsyncClient$createTag_call;
...
# direct methods
.method public constructor <init>(Ljava/lang/String;Lcom/evernote/edam/type/Tag;Lorg/apache/thrift/async/AsyncMethodCallback;Lorg/apache/thrift/async/TAsyncClient;Lorg/apache/thrift/protocol/TProtocolFactory;Lorg/apache/thrift/transport/TNonblockingTransport;)V
    .locals 6
    ...
    .line 4118
    iput-object p1, p0, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$createTag_call;->authenticationToken:Ljava/lang/String;

    .line 4119
    iput-object p2, p0, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$createTag_call;->tag:Lcom/evernote/edam/type/Tag;
...
# virtual methods
.method public getResult()Lcom/evernote/edam/type/Tag;
    .locals 4
    .annotation system Ldalvik/annotation/Throws;
        value = {
    ...
    .prologue
    .line 4132
    invoke-virtual {p0}, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$createTag_call;->getState()Lorg/apache/thrift/async/TAsyncMethodCall$State;
    ...
    invoke-virtual {p0}, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$createTag_call;->getFrameBuffer()Ljava/nio/ByteBuffer;
    ...
    iget-object v2, p0, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$createTag_call;->client:Lorg/apache/thrift/async/TAsyncClient;
    ...
    invoke-virtual {v2}, Lcom/evernote/edam/notestore/NoteStore$Client;->recv_createTag()Lcom/evernote/edam/type/Tag;
...
.method public write_args(Lorg/apache/thrift/protocol/TProtocol;)V
    ...
    iget-object v1, p0, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$createTag_call;->authenticationToken:Ljava/lang/String;

    invoke-virtual {v0, v1}, Lcom/evernote/edam/notestore/NoteStore$createTag_args;->setAuthenticationToken(Ljava/lang/String;)V

    .line 4126
    iget-object v1, p0, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$createTag_call;->tag:Lcom/evernote/edam/type/Tag;

    invoke-virtual {v0, v1}, Lcom/evernote/edam/notestore/NoteStore$createTag_args;->setTag(Lcom/evernote/edam/type/Tag;)V

    .line 4127
    invoke-virtual {v0, p1}, Lcom/evernote/edam/notestore/NoteStore$createTag_args;->write(Lorg/apache/thrift/protocol/TProtocol;)V
