.class public Lcom/evernote/edam/notestore/NoteStore$AsyncClient$expungeNote_call;
...
.method public constructor <init>(Ljava/lang/String;Ljava/lang/String;Lorg/apache/thrift/async/AsyncMethodCallback;Lorg/apache/thrift/async/TAsyncClient;Lorg/apache/thrift/protocol/TProtocolFactory;Lorg/apache/thrift/transport/TNonblockingTransport;)V
    ...
    .line 5016
    iput-object p1, p0, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$expungeNote_call;->authenticationToken:Ljava/lang/String;

    .line 5017
    iput-object p2, p0, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$expungeNote_call;->guid:Ljava/lang/String;
...
.method public getResult()I
    ...
    .prologue
    .line 5030
    invoke-virtual {p0}, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$expungeNote_call;->getState()Lorg/apache/thrift/async/TAsyncMethodCall$State;
    ...
    invoke-virtual {p0}, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$expungeNote_call;->getFrameBuffer()Ljava/nio/ByteBuffer;
    ...
    iget-object v2, p0, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$expungeNote_call;->client:Lorg/apache/thrift/async/TAsyncClient;
    ...
    invoke-virtual {v2}, Lcom/evernote/edam/notestore/NoteStore$Client;->recv_expungeNote()I
...
.method public write_args(Lorg/apache/thrift/protocol/TProtocol;)V
    ...
    iget-object v1, p0, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$expungeNote_call;->authenticationToken:Ljava/lang/String;

    invoke-virtual {v0, v1}, Lcom/evernote/edam/notestore/NoteStore$expungeNote_args;->setAuthenticationToken(Ljava/lang/String;)V

    .line 5024
    iget-object v1, p0, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$expungeNote_call;->guid:Ljava/lang/String;

    invoke-virtual {v0, v1}, Lcom/evernote/edam/notestore/NoteStore$expungeNote_args;->setGuid(Ljava/lang/String;)V

    .line 5025
    invoke-virtual {v0, p1}, Lcom/evernote/edam/notestore/NoteStore$expungeNote_args;->write(Lorg/apache/thrift/protocol/TProtocol;)V
