.class public Lcom/evernote/edam/notestore/NoteStore$AsyncClient$findNotes_call;
...
# direct methods
.method public constructor <init>(Ljava/lang/String;Lcom/evernote/edam/notestore/NoteFilter;IILorg/apache/thrift/async/AsyncMethodCallback;Lorg/apache/thrift/async/TAsyncClient;Lorg/apache/thrift/protocol/TProtocolFactory;Lorg/apache/thrift/transport/TNonblockingTransport;)V
    .locals 6
    ...
    .line 4423
    iput-object p1, p0, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$findNotes_call;->authenticationToken:Ljava/lang/String;

    .line 4424
    iput-object p2, p0, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$findNotes_call;->filter:Lcom/evernote/edam/notestore/NoteFilter;

    .line 4425
    iput p3, p0, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$findNotes_call;->offset:I

    .line 4426
    iput p4, p0, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$findNotes_call;->maxNotes:I
...
# virtual methods
.method public getResult()Lcom/evernote/edam/notestore/NoteList;
    .locals 4
    .annotation system Ldalvik/annotation/Throws;
        value = {
    ...
    .prologue
    .line 4441
    invoke-virtual {p0}, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$findNotes_call;->getState()Lorg/apache/thrift/async/TAsyncMethodCall$State;
    ...
    invoke-virtual {p0}, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$findNotes_call;->getFrameBuffer()Ljava/nio/ByteBuffer;
    ...
    iget-object v2, p0, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$findNotes_call;->client:Lorg/apache/thrift/async/TAsyncClient;
    ...
    invoke-virtual {v2}, Lcom/evernote/edam/notestore/NoteStore$Client;->recv_findNotes()Lcom/evernote/edam/notestore/NoteList;
...
.method public write_args(Lorg/apache/thrift/protocol/TProtocol;)V
    ...
    iget-object v1, p0, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$findNotes_call;->authenticationToken:Ljava/lang/String;

    invoke-virtual {v0, v1}, Lcom/evernote/edam/notestore/NoteStore$findNotes_args;->setAuthenticationToken(Ljava/lang/String;)V

    .line 4433
    iget-object v1, p0, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$findNotes_call;->filter:Lcom/evernote/edam/notestore/NoteFilter;

    invoke-virtual {v0, v1}, Lcom/evernote/edam/notestore/NoteStore$findNotes_args;->setFilter(Lcom/evernote/edam/notestore/NoteFilter;)V

    .line 4434
    iget v1, p0, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$findNotes_call;->offset:I

    invoke-virtual {v0, v1}, Lcom/evernote/edam/notestore/NoteStore$findNotes_args;->setOffset(I)V

    .line 4435
    iget v1, p0, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$findNotes_call;->maxNotes:I

    invoke-virtual {v0, v1}, Lcom/evernote/edam/notestore/NoteStore$findNotes_args;->setMaxNotes(I)V

    .line 4436
    invoke-virtual {v0, p1}, Lcom/evernote/edam/notestore/NoteStore$findNotes_args;->write(Lorg/apache/thrift/protocol/TProtocol;)V
