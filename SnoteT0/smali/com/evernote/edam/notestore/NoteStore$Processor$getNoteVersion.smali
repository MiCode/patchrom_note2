...
.method public process(ILorg/apache/thrift/protocol/TProtocol;Lorg/apache/thrift/protocol/TProtocol;)V
    ...
    .prologue
    .line 8144
    new-instance v8, Lcom/evernote/edam/notestore/NoteStore$getNoteVersion_args;

    invoke-direct {v8}, Lcom/evernote/edam/notestore/NoteStore$getNoteVersion_args;-><init>()V

    .line 8146
    .local v8, args:Lcom/evernote/edam/notestore/NoteStore$getNoteVersion_args;
    :try_start_0
    move-object/from16 v0, p2

    invoke-virtual {v8, v0}, Lcom/evernote/edam/notestore/NoteStore$getNoteVersion_args;->read(Lorg/apache/thrift/protocol/TProtocol;)V
    :try_end_0
    ...
    .line 8157
    new-instance v11, Lcom/evernote/edam/notestore/NoteStore$getNoteVersion_result;

    invoke-direct {v11}, Lcom/evernote/edam/notestore/NoteStore$getNoteVersion_result;-><init>()V

    .line 8159
    .local v11, result:Lcom/evernote/edam/notestore/NoteStore$getNoteVersion_result;
    :try_start_1
    move-object/from16 v0, p0

    iget-object v1, v0, Lcom/evernote/edam/notestore/NoteStore$Processor$getNoteVersion;->this$0:Lcom/evernote/edam/notestore/NoteStore$Processor;
    ...
    invoke-static {v8}, Lcom/evernote/edam/notestore/NoteStore$getNoteVersion_args;->access$46100(Lcom/evernote/edam/notestore/NoteStore$getNoteVersion_args;)Ljava/lang/String;

    move-result-object v2

    #getter for: Lcom/evernote/edam/notestore/NoteStore$getNoteVersion_args;->noteGuid:Ljava/lang/String;
    invoke-static {v8}, Lcom/evernote/edam/notestore/NoteStore$getNoteVersion_args;->access$46200(Lcom/evernote/edam/notestore/NoteStore$getNoteVersion_args;)Ljava/lang/String;

    move-result-object v3

    #getter for: Lcom/evernote/edam/notestore/NoteStore$getNoteVersion_args;->updateSequenceNum:I
    invoke-static {v8}, Lcom/evernote/edam/notestore/NoteStore$getNoteVersion_args;->access$46300(Lcom/evernote/edam/notestore/NoteStore$getNoteVersion_args;)I

    move-result v4

    #getter for: Lcom/evernote/edam/notestore/NoteStore$getNoteVersion_args;->withResourcesData:Z
    invoke-static {v8}, Lcom/evernote/edam/notestore/NoteStore$getNoteVersion_args;->access$46400(Lcom/evernote/edam/notestore/NoteStore$getNoteVersion_args;)Z

    move-result v5

    #getter for: Lcom/evernote/edam/notestore/NoteStore$getNoteVersion_args;->withResourcesRecognition:Z
    invoke-static {v8}, Lcom/evernote/edam/notestore/NoteStore$getNoteVersion_args;->access$46500(Lcom/evernote/edam/notestore/NoteStore$getNoteVersion_args;)Z

    move-result v6

    #getter for: Lcom/evernote/edam/notestore/NoteStore$getNoteVersion_args;->withResourcesAlternateData:Z
    invoke-static {v8}, Lcom/evernote/edam/notestore/NoteStore$getNoteVersion_args;->access$46600(Lcom/evernote/edam/notestore/NoteStore$getNoteVersion_args;)Z

    move-result v7

    invoke-interface/range {v1 .. v7}, Lcom/evernote/edam/notestore/NoteStore$Iface;->getNoteVersion(Ljava/lang/String;Ljava/lang/String;IZZZ)Lcom/evernote/edam/type/Note;

    move-result-object v1

    #setter for: Lcom/evernote/edam/notestore/NoteStore$getNoteVersion_result;->success:Lcom/evernote/edam/type/Note;
    invoke-static {v11, v1}, Lcom/evernote/edam/notestore/NoteStore$getNoteVersion_result;->access$16502(Lcom/evernote/edam/notestore/NoteStore$getNoteVersion_result;Lcom/evernote/edam/type/Note;)Lcom/evernote/edam/type/Note;
    :try_end_1
    ...
    invoke-virtual {v11, v0}, Lcom/evernote/edam/notestore/NoteStore$getNoteVersion_result;->write(Lorg/apache/thrift/protocol/TProtocol;)V
    ...
    .line 8178
    .end local v11           #result:Lcom/evernote/edam/notestore/NoteStore$getNoteVersion_result;
    :goto_1
    return-void
    ...
    .restart local v11       #result:Lcom/evernote/edam/notestore/NoteStore$getNoteVersion_result;
    :catch_1
    move-exception v14
    ...
    invoke-static {v11, v14}, Lcom/evernote/edam/notestore/NoteStore$getNoteVersion_result;->access$16602(Lcom/evernote/edam/notestore/NoteStore$getNoteVersion_result;Lcom/evernote/edam/error/EDAMUserException;)Lcom/evernote/edam/error/EDAMUserException;
    ...
    invoke-static {v11, v12}, Lcom/evernote/edam/notestore/NoteStore$getNoteVersion_result;->access$16702(Lcom/evernote/edam/notestore/NoteStore$getNoteVersion_result;Lcom/evernote/edam/error/EDAMSystemException;)Lcom/evernote/edam/error/EDAMSystemException;
    ...
    invoke-static {v11, v10}, Lcom/evernote/edam/notestore/NoteStore$getNoteVersion_result;->access$16802(Lcom/evernote/edam/notestore/NoteStore$getNoteVersion_result;Lcom/evernote/edam/error/EDAMNotFoundException;)Lcom/evernote/edam/error/EDAMNotFoundException;
    ...
    const-string v2, "Internal error processing getNoteVersion"
