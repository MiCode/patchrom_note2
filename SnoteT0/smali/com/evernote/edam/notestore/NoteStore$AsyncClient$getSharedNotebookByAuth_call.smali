.class public Lcom/evernote/edam/notestore/NoteStore$AsyncClient$getSharedNotebookByAuth_call;
...
.annotation system Ldalvik/annotation/InnerClass;
    accessFlags = 0x9
    name = "getSharedNotebookByAuth_call"
.end annotation
...
.method public constructor <init>(Ljava/lang/String;Lorg/apache/thrift/async/AsyncMethodCallback;Lorg/apache/thrift/async/TAsyncClient;Lorg/apache/thrift/protocol/TProtocolFactory;Lorg/apache/thrift/transport/TNonblockingTransport;)V
    ...
    .line 6080
    iput-object p1, p0, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$getSharedNotebookByAuth_call;->authenticationToken:Ljava/lang/String;
...
.method public getResult()Lcom/evernote/edam/type/SharedNotebook;
    ...
    .prologue
    .line 6092
    invoke-virtual {p0}, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$getSharedNotebookByAuth_call;->getState()Lorg/apache/thrift/async/TAsyncMethodCall$State;
    ...
    invoke-virtual {p0}, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$getSharedNotebookByAuth_call;->getFrameBuffer()Ljava/nio/ByteBuffer;
    ...
    iget-object v2, p0, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$getSharedNotebookByAuth_call;->client:Lorg/apache/thrift/async/TAsyncClient;
    ...
    invoke-virtual {v2}, Lcom/evernote/edam/notestore/NoteStore$Client;->recv_getSharedNotebookByAuth()Lcom/evernote/edam/type/SharedNotebook;
...
.method public write_args(Lorg/apache/thrift/protocol/TProtocol;)V
    ...
    iget-object v1, p0, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$getSharedNotebookByAuth_call;->authenticationToken:Ljava/lang/String;

    invoke-virtual {v0, v1}, Lcom/evernote/edam/notestore/NoteStore$getSharedNotebookByAuth_args;->setAuthenticationToken(Ljava/lang/String;)V

    .line 6087
    invoke-virtual {v0, p1}, Lcom/evernote/edam/notestore/NoteStore$getSharedNotebookByAuth_args;->write(Lorg/apache/thrift/protocol/TProtocol;)V
