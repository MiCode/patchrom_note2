.class public Lcom/evernote/edam/notestore/NoteStore$AsyncClient$getFilteredSyncChunk_call;
...
.annotation system Ldalvik/annotation/InnerClass;
    accessFlags = 0x9
    name = "getFilteredSyncChunk_call"
.end annotation
...
# direct methods
.method public constructor <init>(Ljava/lang/String;IILcom/evernote/edam/notestore/SyncChunkFilter;Lorg/apache/thrift/async/AsyncMethodCallback;Lorg/apache/thrift/async/TAsyncClient;Lorg/apache/thrift/protocol/TProtocolFactory;Lorg/apache/thrift/transport/TNonblockingTransport;)V
    .locals 6
    ...
    .line 3706
    iput-object p1, p0, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$getFilteredSyncChunk_call;->authenticationToken:Ljava/lang/String;

    .line 3707
    iput p2, p0, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$getFilteredSyncChunk_call;->afterUSN:I

    .line 3708
    iput p3, p0, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$getFilteredSyncChunk_call;->maxEntries:I

    .line 3709
    iput-object p4, p0, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$getFilteredSyncChunk_call;->filter:Lcom/evernote/edam/notestore/SyncChunkFilter;
...
.method public getResult()Lcom/evernote/edam/notestore/SyncChunk;
    ...
    .prologue
    .line 3724
    invoke-virtual {p0}, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$getFilteredSyncChunk_call;->getState()Lorg/apache/thrift/async/TAsyncMethodCall$State;
    ...
    invoke-virtual {p0}, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$getFilteredSyncChunk_call;->getFrameBuffer()Ljava/nio/ByteBuffer;
    ...
    iget-object v2, p0, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$getFilteredSyncChunk_call;->client:Lorg/apache/thrift/async/TAsyncClient;
    ...
    invoke-virtual {v2}, Lcom/evernote/edam/notestore/NoteStore$Client;->recv_getFilteredSyncChunk()Lcom/evernote/edam/notestore/SyncChunk;
...
.method public write_args(Lorg/apache/thrift/protocol/TProtocol;)V
    ...
    iget-object v1, p0, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$getFilteredSyncChunk_call;->authenticationToken:Ljava/lang/String;

    invoke-virtual {v0, v1}, Lcom/evernote/edam/notestore/NoteStore$getFilteredSyncChunk_args;->setAuthenticationToken(Ljava/lang/String;)V

    .line 3716
    iget v1, p0, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$getFilteredSyncChunk_call;->afterUSN:I

    invoke-virtual {v0, v1}, Lcom/evernote/edam/notestore/NoteStore$getFilteredSyncChunk_args;->setAfterUSN(I)V

    .line 3717
    iget v1, p0, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$getFilteredSyncChunk_call;->maxEntries:I

    invoke-virtual {v0, v1}, Lcom/evernote/edam/notestore/NoteStore$getFilteredSyncChunk_args;->setMaxEntries(I)V

    .line 3718
    iget-object v1, p0, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$getFilteredSyncChunk_call;->filter:Lcom/evernote/edam/notestore/SyncChunkFilter;

    invoke-virtual {v0, v1}, Lcom/evernote/edam/notestore/NoteStore$getFilteredSyncChunk_args;->setFilter(Lcom/evernote/edam/notestore/SyncChunkFilter;)V

    .line 3719
    invoke-virtual {v0, p1}, Lcom/evernote/edam/notestore/NoteStore$getFilteredSyncChunk_args;->write(Lorg/apache/thrift/protocol/TProtocol;)V
