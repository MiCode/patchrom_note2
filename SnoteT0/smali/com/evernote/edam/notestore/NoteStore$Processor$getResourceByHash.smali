...
.method public process(ILorg/apache/thrift/protocol/TProtocol;Lorg/apache/thrift/protocol/TProtocol;)V
    ...
    .prologue
    .line 8475
    new-instance v8, Lcom/evernote/edam/notestore/NoteStore$getResourceByHash_args;

    invoke-direct {v8}, Lcom/evernote/edam/notestore/NoteStore$getResourceByHash_args;-><init>()V

    .line 8477
    .local v8, args:Lcom/evernote/edam/notestore/NoteStore$getResourceByHash_args;
    :try_start_0
    move-object/from16 v0, p2

    invoke-virtual {v8, v0}, Lcom/evernote/edam/notestore/NoteStore$getResourceByHash_args;->read(Lorg/apache/thrift/protocol/TProtocol;)V
    :try_end_0
    ...
    .line 8488
    new-instance v11, Lcom/evernote/edam/notestore/NoteStore$getResourceByHash_result;

    invoke-direct {v11}, Lcom/evernote/edam/notestore/NoteStore$getResourceByHash_result;-><init>()V

    .line 8490
    .local v11, result:Lcom/evernote/edam/notestore/NoteStore$getResourceByHash_result;
    :try_start_1
    move-object/from16 v0, p0

    iget-object v1, v0, Lcom/evernote/edam/notestore/NoteStore$Processor$getResourceByHash;->this$0:Lcom/evernote/edam/notestore/NoteStore$Processor;
    ...
    invoke-static {v8}, Lcom/evernote/edam/notestore/NoteStore$getResourceByHash_args;->access$48900(Lcom/evernote/edam/notestore/NoteStore$getResourceByHash_args;)Ljava/lang/String;

    move-result-object v2

    #getter for: Lcom/evernote/edam/notestore/NoteStore$getResourceByHash_args;->noteGuid:Ljava/lang/String;
    invoke-static {v8}, Lcom/evernote/edam/notestore/NoteStore$getResourceByHash_args;->access$49000(Lcom/evernote/edam/notestore/NoteStore$getResourceByHash_args;)Ljava/lang/String;

    move-result-object v3

    #getter for: Lcom/evernote/edam/notestore/NoteStore$getResourceByHash_args;->contentHash:[B
    invoke-static {v8}, Lcom/evernote/edam/notestore/NoteStore$getResourceByHash_args;->access$49100(Lcom/evernote/edam/notestore/NoteStore$getResourceByHash_args;)[B

    move-result-object v4

    #getter for: Lcom/evernote/edam/notestore/NoteStore$getResourceByHash_args;->withData:Z
    invoke-static {v8}, Lcom/evernote/edam/notestore/NoteStore$getResourceByHash_args;->access$49200(Lcom/evernote/edam/notestore/NoteStore$getResourceByHash_args;)Z

    move-result v5

    #getter for: Lcom/evernote/edam/notestore/NoteStore$getResourceByHash_args;->withRecognition:Z
    invoke-static {v8}, Lcom/evernote/edam/notestore/NoteStore$getResourceByHash_args;->access$49300(Lcom/evernote/edam/notestore/NoteStore$getResourceByHash_args;)Z

    move-result v6

    #getter for: Lcom/evernote/edam/notestore/NoteStore$getResourceByHash_args;->withAlternateData:Z
    invoke-static {v8}, Lcom/evernote/edam/notestore/NoteStore$getResourceByHash_args;->access$49400(Lcom/evernote/edam/notestore/NoteStore$getResourceByHash_args;)Z

    move-result v7

    invoke-interface/range {v1 .. v7}, Lcom/evernote/edam/notestore/NoteStore$Iface;->getResourceByHash(Ljava/lang/String;Ljava/lang/String;[BZZZ)Lcom/evernote/edam/type/Resource;

    move-result-object v1

    #setter for: Lcom/evernote/edam/notestore/NoteStore$getResourceByHash_result;->success:Lcom/evernote/edam/type/Resource;
    invoke-static {v11, v1}, Lcom/evernote/edam/notestore/NoteStore$getResourceByHash_result;->access$19702(Lcom/evernote/edam/notestore/NoteStore$getResourceByHash_result;Lcom/evernote/edam/type/Resource;)Lcom/evernote/edam/type/Resource;
    :try_end_1
    ...
    invoke-virtual {v11, v0}, Lcom/evernote/edam/notestore/NoteStore$getResourceByHash_result;->write(Lorg/apache/thrift/protocol/TProtocol;)V
    ...
    .line 8509
    .end local v11           #result:Lcom/evernote/edam/notestore/NoteStore$getResourceByHash_result;
    :goto_1
    return-void
    ...
    .restart local v11       #result:Lcom/evernote/edam/notestore/NoteStore$getResourceByHash_result;
    :catch_1
    move-exception v14
    ...
    invoke-static {v11, v14}, Lcom/evernote/edam/notestore/NoteStore$getResourceByHash_result;->access$19802(Lcom/evernote/edam/notestore/NoteStore$getResourceByHash_result;Lcom/evernote/edam/error/EDAMUserException;)Lcom/evernote/edam/error/EDAMUserException;
    ...
    invoke-static {v11, v12}, Lcom/evernote/edam/notestore/NoteStore$getResourceByHash_result;->access$19902(Lcom/evernote/edam/notestore/NoteStore$getResourceByHash_result;Lcom/evernote/edam/error/EDAMSystemException;)Lcom/evernote/edam/error/EDAMSystemException;
    ...
    invoke-static {v11, v10}, Lcom/evernote/edam/notestore/NoteStore$getResourceByHash_result;->access$20002(Lcom/evernote/edam/notestore/NoteStore$getResourceByHash_result;Lcom/evernote/edam/error/EDAMNotFoundException;)Lcom/evernote/edam/error/EDAMNotFoundException;
    ...
    const-string v2, "Internal error processing getResourceByHash"
