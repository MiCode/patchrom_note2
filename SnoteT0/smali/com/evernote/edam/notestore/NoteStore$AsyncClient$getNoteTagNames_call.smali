.class public Lcom/evernote/edam/notestore/NoteStore$AsyncClient$getNoteTagNames_call;
...
.method public constructor <init>(Ljava/lang/String;Ljava/lang/String;Lorg/apache/thrift/async/AsyncMethodCallback;Lorg/apache/thrift/async/TAsyncClient;Lorg/apache/thrift/protocol/TProtocolFactory;Lorg/apache/thrift/transport/TNonblockingTransport;)V
    ...
    .line 4880
    iput-object p1, p0, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$getNoteTagNames_call;->authenticationToken:Ljava/lang/String;

    .line 4881
    iput-object p2, p0, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$getNoteTagNames_call;->guid:Ljava/lang/String;
...
.method public getResult()Ljava/util/List;
    ...
    .prologue
    .line 4894
    invoke-virtual {p0}, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$getNoteTagNames_call;->getState()Lorg/apache/thrift/async/TAsyncMethodCall$State;
    ...
    invoke-virtual {p0}, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$getNoteTagNames_call;->getFrameBuffer()Ljava/nio/ByteBuffer;
    ...
    iget-object v2, p0, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$getNoteTagNames_call;->client:Lorg/apache/thrift/async/TAsyncClient;
    ...
    invoke-virtual {v2}, Lcom/evernote/edam/notestore/NoteStore$Client;->recv_getNoteTagNames()Ljava/util/List;
...
.method public write_args(Lorg/apache/thrift/protocol/TProtocol;)V
    ...
    iget-object v1, p0, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$getNoteTagNames_call;->authenticationToken:Ljava/lang/String;

    invoke-virtual {v0, v1}, Lcom/evernote/edam/notestore/NoteStore$getNoteTagNames_args;->setAuthenticationToken(Ljava/lang/String;)V

    .line 4888
    iget-object v1, p0, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$getNoteTagNames_call;->guid:Ljava/lang/String;

    invoke-virtual {v0, v1}, Lcom/evernote/edam/notestore/NoteStore$getNoteTagNames_args;->setGuid(Ljava/lang/String;)V

    .line 4889
    invoke-virtual {v0, p1}, Lcom/evernote/edam/notestore/NoteStore$getNoteTagNames_args;->write(Lorg/apache/thrift/protocol/TProtocol;)V
