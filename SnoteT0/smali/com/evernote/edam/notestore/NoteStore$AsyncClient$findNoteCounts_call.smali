.class public Lcom/evernote/edam/notestore/NoteStore$AsyncClient$findNoteCounts_call;
...
# direct methods
.method public constructor <init>(Ljava/lang/String;Lcom/evernote/edam/notestore/NoteFilter;ZLorg/apache/thrift/async/AsyncMethodCallback;Lorg/apache/thrift/async/TAsyncClient;Lorg/apache/thrift/protocol/TProtocolFactory;Lorg/apache/thrift/transport/TNonblockingTransport;)V
    .locals 6
    ...
    .line 4542
    iput-object p1, p0, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$findNoteCounts_call;->authenticationToken:Ljava/lang/String;

    .line 4543
    iput-object p2, p0, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$findNoteCounts_call;->filter:Lcom/evernote/edam/notestore/NoteFilter;

    .line 4544
    iput-boolean p3, p0, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$findNoteCounts_call;->withTrash:Z
...
# virtual methods
.method public getResult()Lcom/evernote/edam/notestore/NoteCollectionCounts;
    .locals 4
    .annotation system Ldalvik/annotation/Throws;
        value = {
    ...
    .prologue
    .line 4558
    invoke-virtual {p0}, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$findNoteCounts_call;->getState()Lorg/apache/thrift/async/TAsyncMethodCall$State;
    ...
    invoke-virtual {p0}, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$findNoteCounts_call;->getFrameBuffer()Ljava/nio/ByteBuffer;
    ...
    iget-object v2, p0, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$findNoteCounts_call;->client:Lorg/apache/thrift/async/TAsyncClient;
    ...
    invoke-virtual {v2}, Lcom/evernote/edam/notestore/NoteStore$Client;->recv_findNoteCounts()Lcom/evernote/edam/notestore/NoteCollectionCounts;
...
.method public write_args(Lorg/apache/thrift/protocol/TProtocol;)V
    ...
    iget-object v1, p0, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$findNoteCounts_call;->authenticationToken:Ljava/lang/String;

    invoke-virtual {v0, v1}, Lcom/evernote/edam/notestore/NoteStore$findNoteCounts_args;->setAuthenticationToken(Ljava/lang/String;)V

    .line 4551
    iget-object v1, p0, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$findNoteCounts_call;->filter:Lcom/evernote/edam/notestore/NoteFilter;

    invoke-virtual {v0, v1}, Lcom/evernote/edam/notestore/NoteStore$findNoteCounts_args;->setFilter(Lcom/evernote/edam/notestore/NoteFilter;)V

    .line 4552
    iget-boolean v1, p0, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$findNoteCounts_call;->withTrash:Z

    invoke-virtual {v0, v1}, Lcom/evernote/edam/notestore/NoteStore$findNoteCounts_args;->setWithTrash(Z)V

    .line 4553
    invoke-virtual {v0, p1}, Lcom/evernote/edam/notestore/NoteStore$findNoteCounts_args;->write(Lorg/apache/thrift/protocol/TProtocol;)V
