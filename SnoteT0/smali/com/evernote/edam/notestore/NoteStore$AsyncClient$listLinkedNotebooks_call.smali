.class public Lcom/evernote/edam/notestore/NoteStore$AsyncClient$listLinkedNotebooks_call;
...
.method public constructor <init>(Ljava/lang/String;Lorg/apache/thrift/async/AsyncMethodCallback;Lorg/apache/thrift/async/TAsyncClient;Lorg/apache/thrift/protocol/TProtocolFactory;Lorg/apache/thrift/transport/TNonblockingTransport;)V
    ...
    .line 5981
    iput-object p1, p0, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$listLinkedNotebooks_call;->authenticationToken:Ljava/lang/String;
...
.method public getResult()Ljava/util/List;
    ...
    .prologue
    .line 5993
    invoke-virtual {p0}, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$listLinkedNotebooks_call;->getState()Lorg/apache/thrift/async/TAsyncMethodCall$State;
    ...
    invoke-virtual {p0}, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$listLinkedNotebooks_call;->getFrameBuffer()Ljava/nio/ByteBuffer;
    ...
    iget-object v2, p0, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$listLinkedNotebooks_call;->client:Lorg/apache/thrift/async/TAsyncClient;
    ...
    invoke-virtual {v2}, Lcom/evernote/edam/notestore/NoteStore$Client;->recv_listLinkedNotebooks()Ljava/util/List;
...
.method public write_args(Lorg/apache/thrift/protocol/TProtocol;)V
    ...
    iget-object v1, p0, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$listLinkedNotebooks_call;->authenticationToken:Ljava/lang/String;

    invoke-virtual {v0, v1}, Lcom/evernote/edam/notestore/NoteStore$listLinkedNotebooks_args;->setAuthenticationToken(Ljava/lang/String;)V

    .line 5988
    invoke-virtual {v0, p1}, Lcom/evernote/edam/notestore/NoteStore$listLinkedNotebooks_args;->write(Lorg/apache/thrift/protocol/TProtocol;)V
