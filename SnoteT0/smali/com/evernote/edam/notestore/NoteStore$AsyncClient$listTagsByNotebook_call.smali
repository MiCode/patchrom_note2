.class public Lcom/evernote/edam/notestore/NoteStore$AsyncClient$listTagsByNotebook_call;
...
.method public constructor <init>(Ljava/lang/String;Ljava/lang/String;Lorg/apache/thrift/async/AsyncMethodCallback;Lorg/apache/thrift/async/TAsyncClient;Lorg/apache/thrift/protocol/TProtocolFactory;Lorg/apache/thrift/transport/TNonblockingTransport;)V
    ...
    .line 4050
    iput-object p1, p0, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$listTagsByNotebook_call;->authenticationToken:Ljava/lang/String;

    .line 4051
    iput-object p2, p0, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$listTagsByNotebook_call;->notebookGuid:Ljava/lang/String;
...
.method public getResult()Ljava/util/List;
    ...
    .prologue
    .line 4064
    invoke-virtual {p0}, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$listTagsByNotebook_call;->getState()Lorg/apache/thrift/async/TAsyncMethodCall$State;
    ...
    invoke-virtual {p0}, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$listTagsByNotebook_call;->getFrameBuffer()Ljava/nio/ByteBuffer;
    ...
    iget-object v2, p0, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$listTagsByNotebook_call;->client:Lorg/apache/thrift/async/TAsyncClient;
    ...
    invoke-virtual {v2}, Lcom/evernote/edam/notestore/NoteStore$Client;->recv_listTagsByNotebook()Ljava/util/List;
...
.method public write_args(Lorg/apache/thrift/protocol/TProtocol;)V
    ...
    iget-object v1, p0, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$listTagsByNotebook_call;->authenticationToken:Ljava/lang/String;

    invoke-virtual {v0, v1}, Lcom/evernote/edam/notestore/NoteStore$listTagsByNotebook_args;->setAuthenticationToken(Ljava/lang/String;)V

    .line 4058
    iget-object v1, p0, Lcom/evernote/edam/notestore/NoteStore$AsyncClient$listTagsByNotebook_call;->notebookGuid:Ljava/lang/String;

    invoke-virtual {v0, v1}, Lcom/evernote/edam/notestore/NoteStore$listTagsByNotebook_args;->setNotebookGuid(Ljava/lang/String;)V

    .line 4059
    invoke-virtual {v0, p1}, Lcom/evernote/edam/notestore/NoteStore$listTagsByNotebook_args;->write(Lorg/apache/thrift/protocol/TProtocol;)V
