.class public Lcom/evernote/edam/userstore/UserStore$AsyncClient$getUser_call;
...
.method public constructor <init>(Ljava/lang/String;Lorg/apache/thrift/async/AsyncMethodCallback;Lorg/apache/thrift/async/TAsyncClient;Lorg/apache/thrift/protocol/TProtocolFactory;Lorg/apache/thrift/transport/TNonblockingTransport;)V
    ...
    .line 472
    iput-object p1, p0, Lcom/evernote/edam/userstore/UserStore$AsyncClient$getUser_call;->authenticationToken:Ljava/lang/String;
...
# virtual methods
.method public getResult()Lcom/evernote/edam/type/User;
    .locals 4
    .annotation system Ldalvik/annotation/Throws;
        value = {
    ...
    .prologue
    .line 484
    invoke-virtual {p0}, Lcom/evernote/edam/userstore/UserStore$AsyncClient$getUser_call;->getState()Lorg/apache/thrift/async/TAsyncMethodCall$State;
    ...
    invoke-virtual {p0}, Lcom/evernote/edam/userstore/UserStore$AsyncClient$getUser_call;->getFrameBuffer()Ljava/nio/ByteBuffer;
    ...
    iget-object v2, p0, Lcom/evernote/edam/userstore/UserStore$AsyncClient$getUser_call;->client:Lorg/apache/thrift/async/TAsyncClient;
    ...
    invoke-virtual {v2}, Lcom/evernote/edam/userstore/UserStore$Client;->recv_getUser()Lcom/evernote/edam/type/User;
...
.method public write_args(Lorg/apache/thrift/protocol/TProtocol;)V
    ...
    iget-object v1, p0, Lcom/evernote/edam/userstore/UserStore$AsyncClient$getUser_call;->authenticationToken:Ljava/lang/String;

    invoke-virtual {v0, v1}, Lcom/evernote/edam/userstore/UserStore$getUser_args;->setAuthenticationToken(Ljava/lang/String;)V

    .line 479
    invoke-virtual {v0, p1}, Lcom/evernote/edam/userstore/UserStore$getUser_args;->write(Lorg/apache/thrift/protocol/TProtocol;)V
