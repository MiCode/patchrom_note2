.class public Lcom/evernote/edam/userstore/UserStore$AsyncClient$getPublicUserInfo_call;
...
.method public constructor <init>(Ljava/lang/String;Lorg/apache/thrift/async/AsyncMethodCallback;Lorg/apache/thrift/async/TAsyncClient;Lorg/apache/thrift/protocol/TProtocolFactory;Lorg/apache/thrift/transport/TNonblockingTransport;)V
    ...
    .line 503
    iput-object p1, p0, Lcom/evernote/edam/userstore/UserStore$AsyncClient$getPublicUserInfo_call;->username:Ljava/lang/String;
...
# virtual methods
.method public getResult()Lcom/evernote/edam/userstore/PublicUserInfo;
    .locals 4
    .annotation system Ldalvik/annotation/Throws;
        value = {
    ...
    .prologue
    .line 515
    invoke-virtual {p0}, Lcom/evernote/edam/userstore/UserStore$AsyncClient$getPublicUserInfo_call;->getState()Lorg/apache/thrift/async/TAsyncMethodCall$State;
    ...
    invoke-virtual {p0}, Lcom/evernote/edam/userstore/UserStore$AsyncClient$getPublicUserInfo_call;->getFrameBuffer()Ljava/nio/ByteBuffer;
    ...
    iget-object v2, p0, Lcom/evernote/edam/userstore/UserStore$AsyncClient$getPublicUserInfo_call;->client:Lorg/apache/thrift/async/TAsyncClient;
    ...
    invoke-virtual {v2}, Lcom/evernote/edam/userstore/UserStore$Client;->recv_getPublicUserInfo()Lcom/evernote/edam/userstore/PublicUserInfo;
...
.method public write_args(Lorg/apache/thrift/protocol/TProtocol;)V
    ...
    iget-object v1, p0, Lcom/evernote/edam/userstore/UserStore$AsyncClient$getPublicUserInfo_call;->username:Ljava/lang/String;

    invoke-virtual {v0, v1}, Lcom/evernote/edam/userstore/UserStore$getPublicUserInfo_args;->setUsername(Ljava/lang/String;)V

    .line 510
    invoke-virtual {v0, p1}, Lcom/evernote/edam/userstore/UserStore$getPublicUserInfo_args;->write(Lorg/apache/thrift/protocol/TProtocol;)V
