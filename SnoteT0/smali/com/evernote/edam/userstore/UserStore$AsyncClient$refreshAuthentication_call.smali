.class public Lcom/evernote/edam/userstore/UserStore$AsyncClient$refreshAuthentication_call;
...
.annotation system Ldalvik/annotation/InnerClass;
    accessFlags = 0x9
    name = "refreshAuthentication_call"
.end annotation
...
.method public constructor <init>(Ljava/lang/String;Lorg/apache/thrift/async/AsyncMethodCallback;Lorg/apache/thrift/async/TAsyncClient;Lorg/apache/thrift/protocol/TProtocolFactory;Lorg/apache/thrift/transport/TNonblockingTransport;)V
    ...
    .line 441
    iput-object p1, p0, Lcom/evernote/edam/userstore/UserStore$AsyncClient$refreshAuthentication_call;->authenticationToken:Ljava/lang/String;
...
.method public getResult()Lcom/evernote/edam/userstore/AuthenticationResult;
    ...
    .prologue
    .line 453
    invoke-virtual {p0}, Lcom/evernote/edam/userstore/UserStore$AsyncClient$refreshAuthentication_call;->getState()Lorg/apache/thrift/async/TAsyncMethodCall$State;
    ...
    invoke-virtual {p0}, Lcom/evernote/edam/userstore/UserStore$AsyncClient$refreshAuthentication_call;->getFrameBuffer()Ljava/nio/ByteBuffer;
    ...
    iget-object v2, p0, Lcom/evernote/edam/userstore/UserStore$AsyncClient$refreshAuthentication_call;->client:Lorg/apache/thrift/async/TAsyncClient;
    ...
    invoke-virtual {v2}, Lcom/evernote/edam/userstore/UserStore$Client;->recv_refreshAuthentication()Lcom/evernote/edam/userstore/AuthenticationResult;
...
.method public write_args(Lorg/apache/thrift/protocol/TProtocol;)V
    ...
    iget-object v1, p0, Lcom/evernote/edam/userstore/UserStore$AsyncClient$refreshAuthentication_call;->authenticationToken:Ljava/lang/String;

    invoke-virtual {v0, v1}, Lcom/evernote/edam/userstore/UserStore$refreshAuthentication_args;->setAuthenticationToken(Ljava/lang/String;)V

    .line 448
    invoke-virtual {v0, p1}, Lcom/evernote/edam/userstore/UserStore$refreshAuthentication_args;->write(Lorg/apache/thrift/protocol/TProtocol;)V
