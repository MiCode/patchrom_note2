...
.method public onClick(Landroid/content/DialogInterface;I)V
    ...
    invoke-static {v0}, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->access$6500(Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;)Landroid/net/wifi/p2p/WifiP2pConfig;
    ...
    iget-object v3, p0, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine$3;->this$1:Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;

    #getter for: Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->mSavedPeerConfig:Landroid/net/wifi/p2p/WifiP2pConfig;
    invoke-static {v3}, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->access$6500(Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;)Landroid/net/wifi/p2p/WifiP2pConfig;
    ...
    invoke-static {v2, v3}, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->access$9100(Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v0, v1}, Landroid/net/wifi/p2p/WifiP2pService;->access$14402(Landroid/net/wifi/p2p/WifiP2pService;I)I
    ...
    invoke-static {v0}, Landroid/net/wifi/p2p/WifiP2pService;->access$14800(Landroid/net/wifi/p2p/WifiP2pService;)Landroid/os/CountDownTimer;
    ...
    invoke-static {v0}, Landroid/net/wifi/p2p/WifiP2pService;->access$14600(Landroid/net/wifi/p2p/WifiP2pService;)Landroid/os/PowerManager$WakeLock;
